...
public class M838S010100 extends SqlAdapter{
	Connection con = null;
...
//			String rcvData = (String)((ioParam.getInputHashObject()).get("rcvData", HashObject.YES));
			...
			e.printStackTrace();
			LoggingWriter.setLogError("M838S010100E104()","==== SQL ERROR ===="+ e.getMessage());
	    	...
	    	if (Config.useDataSource) {
				try {
					...
					LoggingWriter.setLogError("M838S010100E104()","==== finally ===="+ e.getMessage());
				}
	    	} else {
	    	}
	    }
