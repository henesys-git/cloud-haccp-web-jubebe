 ...
 * 개요 : 이벤트ID별 메소드 정의
 */
public class M838S015200 extends SqlAdapter {
	static final Logger logger = Logger.getLogger(M838S015200.class.getName());
	...
	public int doExcute(InoutParameter ioParam){
	    ...
	    try{
			...
			Method method = M838S015200.class.getMethod(event,optClass);
			LoggingWriter.setLogDebug(M838S015200.class.getName(),"==== " + event + " EventMethod Create Success ====");

			obj = method.invoke(M838S015200.class.newInstance(),optObj);
			doExcute_result = CommonFunction.getInt(obj.toString());
			
	    } catch (Exception ex) {
	    	doExcute_result = EventDefine.E_DOEXCUTE_INIT;
			ioParam.setMessage(MessageDefine.M_NO_EVENTID);
			LoggingWriter.setLogError(M838S015200.class.getName(),"==== EventID Not define : EVENT ID [ " + ioParam.getEventID() + "]");
	    } finally {
	    	obj = null;
			optClass = null;
			optObj = null;
	...
	public int E101(InoutParameter ioParam){ 
		...
		try {
			...
			e.getStackTrace();
			LoggingWriter.setLogError("M838S015200E101()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	...
	public int E111(InoutParameter ioParam){ 
		...
		try {
    		...
    		System.out.println("JSONObject jArray rcvData="+ jArray.toString());
    			...
    			sql = new StringBuilder()
    				.append("INSERT INTO					\n")
    				.append("	haccp_ccp_3b_detail (		\n")
    				.append("		checklist_id,			\n")
    				.append("		checklist_rev_no,		\n")
    				.append("		prod_cd,				\n")
    				.append("       revision_no, 			\n")
    				.append(" 		ccp_date,				\n")
    				.append("       water_activity, 		\n")
    				.append(" 		note,					\n")
    				.append("		measure_date			\n")
    				.append(" 		)						\n")
    				.append("VALUES (											\n")
					...
					.append(" 		'"	+ jArray.get("ccp_date") + "',			\n")
					.append(" 		'"	+ jArray.get("water_activity") + "',	\n")
					.append(" 		'"	+ jArray.get("note") + "',				\n")
					.append(" 		'"	+ jArray.get("measure_date") + "'		\n")
					.append("	) 												\n")
					.toString();
			...
			e.getStackTrace();
			LoggingWriter.setLogError("M838S015200E111()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
	...
	public int E102(InoutParameter ioParam){ 
		...
		try {
			...
			e.getStackTrace();
			LoggingWriter.setLogError("M838S015200E102()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
	...
	public int E112(InoutParameter ioParam){ 
		...
		try {
    		...
    		System.out.println("JSONObject jArray rcvData="+ jArray.toString());
     		...
     		sql = new StringBuilder()
    				.append("UPDATE													  \n")
    				.append("	haccp_ccp_3b_detail SET								  \n")
			...
			e.getStackTrace();
			LoggingWriter.setLogError("M838S015200E112()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
	...
	public int E103(InoutParameter ioParam){ 
		...
		try {
			...
			e.getStackTrace();
			LoggingWriter.setLogError("M838S015200E103()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
	...
	public int E113(InoutParameter ioParam){ 
		...
		try {
			...
			e.getStackTrace();
			LoggingWriter.setLogError("M838S015200E113()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
	...
	public int E104(InoutParameter ioParam){
		...
		try {
			...
			e.printStackTrace();
			LoggingWriter.setLogError("M838S015200E104()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
					...
					LoggingWriter.setLogError("M838S015200E104()","==== finally ===="+ e.getMessage());
				}
	    	}
	    }
	...
	public int E114(InoutParameter ioParam){
		...
		try {
			...
			String sql = new StringBuilder()
					...
					.append("	remarks\n")
					.append("FROM\n")
					.append("	haccp_ccp_3b_detail D JOIN haccp_ccp_3b C\n")
			...
			e.printStackTrace();
			LoggingWriter.setLogError("M838S015200E114()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
					...
					LoggingWriter.setLogError("M838S015200E114()","==== finally ===="+ e.getMessage());
				}
	    	}
	    }
	...
	public int E144(InoutParameter ioParam){
		...
		try {
			...
			String sql = new StringBuilder()
					...
					.append("FROM\n")
					.append("	haccp_ccp_3b A \n")
					.append("	LEFT JOIN haccp_ccp_3b_detail B\n")
			...
			e.printStackTrace();
			LoggingWriter.setLogError("M838S015200E144()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
					...
					LoggingWriter.setLogError("M838S015200E144()","==== finally ===="+ e.getMessage());
				}
	    	} else {
	    	}
	    }
	...
	public int E145(InoutParameter ioParam){
		...
		try {
			...
			String sql = new StringBuilder()
					...
					.append("FROM\n")
					.append("	haccp_ccp_3b A \n")
					.append("	JOIN haccp_ccp_3b_detail B\n")
					.append("		ON A.ccp_date = B.ccp_date\n")
					.append("	LEFT JOIN tbm_users C\n")
			...
			e.printStackTrace();
			LoggingWriter.setLogError("M838S015200E145()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
					...
					LoggingWriter.setLogError("M838S015200E145()","==== finally ===="+ e.getMessage());
				}
	    	} else {
	    	}
	    }
	...
	public int E502(InoutParameter ioParam){ 
		...
		try {
			...
			e.getStackTrace();
			LoggingWriter.setLogError("M838S015200E502()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
	...
	public int E512(InoutParameter ioParam){ 
		...
		try {
			...
			e.getStackTrace();
			LoggingWriter.setLogError("M838S015200E512()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
	...
	public int E522(InoutParameter ioParam){ 
		...
		try {
			...
			e.getStackTrace();
			LoggingWriter.setLogError("M838S015200E522()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
	...
	public int E532(InoutParameter ioParam){ 
		...
		try {
    		...
    		String sql = new StringBuilder()
    				.append("UPDATE haccp_ccp_3b_detail								\n")
    				.append("SET													\n")
