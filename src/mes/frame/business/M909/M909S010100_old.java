 ...
 * 개요 : 이벤트ID별 메소드 정의
 */
public class M909S010100_old extends SqlAdapter {
	
	static final Logger logger = Logger.getLogger(M909S010100_old.class.getName());
	...
	public int doExcute(InoutParameter ioParam){
	    ...
	    try{
			...
			Method method = M909S010100_old.class.getMethod(event,optClass);
			logger.debug(event + " EventMethod Create Success");
			
			obj = method.invoke(M909S010100_old.class.newInstance(),optObj);
