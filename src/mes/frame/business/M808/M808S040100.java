...
public class M808S040100 extends SqlAdapter{
	Connection con = null;
	...
	public  int doExcute(InoutParameter ioParam){
	    ...
	    try{
			...
			Method method = M808S040100.class.getMethod(event,optClass);
			LoggingWriter.setLogDebug(M808S040100.class.getName(),"==== " + event + " EventMethod Create Success ====");

			obj = method.invoke(M808S040100.class.newInstance(),optObj);
			doExcute_result = CommonFunction.getInt(obj.toString());
			
	    } catch (Exception ex) {
	    	doExcute_result = EventDefine.E_DOEXCUTE_INIT;
			ioParam.setMessage(MessageDefine.M_NO_EVENTID);
			LoggingWriter.setLogError(M808S040100.class.getName(),"==== EventID Not define : EVENT ID [ " + ioParam.getEventID() + "]");
	    } finally {
	    	obj = null;
			optClass = null;
			optObj = null;
		...
		LoggingWriter.setLogAll(M808S040100.class.getName(),"==== Query [수행시간  : " + runningTime + " ms]");
	...
	public int E101(InoutParameter ioParam){
		...
		try {
			...
			LoggingWriter.setLogError("M808S040100E101()","==== SQL ERROR ===="+ e.getMessage() + "\n" + sql.toString());
	    	...
	    	if (Config.useDataSource) {
				try {
					...
					LoggingWriter.setLogError("M808S040100E101()","==== finally ===="+ e.getMessage());
				}
	    	} else {
	    	}
	    }
	...
	public int E102(InoutParameter ioParam){
		...
		try {
			...
			LoggingWriter.setLogError("M808S040100E102()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
					...
					LoggingWriter.setLogError("M808S040100E102()","==== finally ===="+ e.getMessage());
				}
	    	} else {
	    	}
	    }
	...
	public int E103(InoutParameter ioParam){
		...
		try {
			...
			LoggingWriter.setLogError("M808S040100E103()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
					...
					LoggingWriter.setLogError("M808S040100E103()","==== finally ===="+ e.getMessage());
				}
	    	} else {
	    	}
	    }
...
//			String[][] c_paramArray = CommonFunction.getConvString2DoubleArray(rcvData);
			...
			e.printStackTrace();
			LoggingWriter.setLogError("M808S040100E104()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
					...
					LoggingWriter.setLogError("M808S040100E104()","==== finally ===="+ e.getMessage());
				}
	    	} else {
	    	}
	    }
	...
	public int E114(InoutParameter ioParam){
		...
		try {
			...
			e.printStackTrace();
			LoggingWriter.setLogError("M808S040100E114()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
					...
					LoggingWriter.setLogError("M808S040100E114()","==== finally ===="+ e.getMessage());
				}
	    	} else {
	    	}
	    }
...
//			String[][] c_paramArray = CommonFunction.getConvString2DoubleArray(rcvData);
			...
			e.printStackTrace();
			LoggingWriter.setLogError("M808S040100E214()","==== SQL ERROR ===="+ e.getMessage());
			return EventDefine.E_DOEXCUTE_ERROR ;
	    } finally {
	    	if (Config.useDataSource) {
				try {
					...
					LoggingWriter.setLogError("M808S040100E214()","==== finally ===="+ e.getMessage());
				}
	    	} else {
	    	}
	    }
