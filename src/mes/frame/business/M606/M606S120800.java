...
public class M606S120800 extends SqlAdapter {
	Connection con = null;
	...
	public int doExcute(InoutParameter ioParam) {
		...
		try {
			...
			Method method = M606S120800.class.getMethod(event, optClass);
			LoggingWriter.setLogDebug(M606S120800.class.getName(),
					"==== " + event + " EventMethod Create Success ====");

			obj = method.invoke(M606S120800.class.newInstance(), optObj);
			doExcute_result = CommonFunction.getInt(obj.toString());

		} catch (Exception ex) {
			doExcute_result = EventDefine.E_DOEXCUTE_INIT;
			ioParam.setMessage(MessageDefine.M_NO_EVENTID);
			LoggingWriter.setLogError(M606S120800.class.getName(),
		...
		LoggingWriter.setLogAll(M606S120800.class.getName(), "==== Query [수행시간  : " + runningTime + " ms]");
...
//			String[][] c_paramArray = CommonFunction.getConvString2DoubleArray(rcvData);
			...
			String sql = new StringBuilder()
					...
					.append("where B.gubun_code = 'DOCG004'	\n")
...
//					.append("and   D.action_process like '" 	+ c_paramArray[0][1] + "%'	\n")
			...
			e.printStackTrace();
			LoggingWriter.setLogError("M606S120800E104()", "==== SQL ERROR ====" + e.getMessage());
			...
			if (Config.useDataSource) {
				try {
					...
					LoggingWriter.setLogError("M606S120800E104()","==== finally ===="+ e.getMessage());
				}
			} else {
			}
		}
