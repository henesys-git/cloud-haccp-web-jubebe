...
public class M404S010700 extends SqlAdapter{
	Connection con = null;
	...
	public int doExcute(InoutParameter ioParam){
	    ...
	    try{
			...
			Method method = M404S010700.class.getMethod(event,optClass);
			LoggingWriter.setLogDebug(M404S010700.class.getName(),"==== " + event + " EventMethod Create Success ====");

			obj = method.invoke(M404S010700.class.newInstance(),optObj);
			doExcute_result = CommonFunction.getInt(obj.toString());
			
	    } catch (Exception ex) {
	    	doExcute_result = EventDefine.E_DOEXCUTE_INIT;
			ioParam.setMessage(MessageDefine.M_NO_EVENTID);
			LoggingWriter.setLogError(M404S010700.class.getName(),"==== EventID Not define : EVENT ID [ " + ioParam.getEventID() + "]");
	    } finally {
	    	obj = null;
			optClass = null;
			optObj = null;
		...
		LoggingWriter.setLogAll(M404S010700.class.getName(),"==== Query [수행시간  : " + runningTime + " ms]");
	...
	public int E104(InoutParameter ioParam){
		...
		try {
			...
			e.printStackTrace();
			LoggingWriter.setLogError("M404S010700E104()","==== SQL ERROR ===="+ e.getMessage());
	    	...
	    	if (Config.useDataSource) {
				try {
					...
					LoggingWriter.setLogError("M404S010700E104()","==== finally ===="+ e.getMessage());
				}
	    	} else {
	    	}
	    }
