...
@WebServlet(
	name = "PublicSigningKeyBase64Servlet",
	urlPatterns = "/publicSigningKeyBase64"
)
public class PublicSigningKeyBase64Servlet extends HttpServlet {
