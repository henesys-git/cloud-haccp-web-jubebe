...
/**
	...
	@version 1.30   - Minor fixes to setEncoding(String enc), thanks to Rob Gaunt & ZiP (zip_dev)
...
public class MultipartRequest
{
    ...
    */
//    public static final int MAX_READ_BYTES = 50 * (1024 * 1024); // 2MB!
    public static final int MAX_READ_BYTES = 2 * (1024 * 1024); // 2MB! //20181212¼öÁ¤
    ...
    */
     ...
     *
     * @see #MAX_READ_BYTES
     * @deprecated Replaced by MultipartRequest(PrintWriter, String, int, InputStream, String, int, String)  
     */
     ...
     *
     * @see #MAX_READ_BYTES
     * @deprecated Replaced by MultipartRequest(PrintWriter, String, int, InputStream, int, String)  
     */
    public MultipartRequest(PrintWriter debug, 
                            String strContentTypeText, 
                            int intContentLength, 
                        ...
                        String encoding) throws IllegalArgumentException, IOException, UnsupportedEncodingException
    {
        ...
        if (!loadIntoMemory && strSaveDirectory!=null)
        {
            ...
            System.out.println("MultipartRequest: strSaveDirectory=" + strSaveDirectory);
        ...
        if (strContentTypeText!=null && strContentTypeText.startsWith("multipart/") && strContentTypeText.indexOf("boundary=")!=-1)
...
//        try {
        ...
        while (true)
        {
            ...
            else
            {
            	...
            	System.out.println("strFilename==" + strFilename);//2019-01-11 jh
            	System.out.println("charEncoding==" + charEncoding);//2019-01-11 jh
//            	System.out.println("strFilename==" + strFilename);
                // No filename specified at all - parameter
                if (strFilename==null)
                {
                	System.out.println("strName==" + strName);//2019-01-11 jh
                    // Skip blank line.
                ...
                else// (strFilename!=null)
                {
                    ...
                    else // File uploaded, or at least a filename was specified, it could still be spurious.
                    {
                        ...
                        if (filesize>0)
                            ...
                            addFileParameter(strName, new Object[] {strFilename, null, new Long(0), null, null, strRawFilename});
                    }
