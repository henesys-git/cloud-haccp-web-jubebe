...
%>
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
    	...
    	var date = new SetRangeDate("dateParent", "dateRange", 150);
    ...
    function fn_MainInfo_List(startDate, endDate) {
        $.ajax({
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S070750.jsp",
            data: "From=" + startDate + 
            	  "&To=" + endDate,
    ...
    function fn_DetailInfo_List() {     
    	$.ajax({
   	    	type: "POST",
   	        url: "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S070760.jsp",
    ...
    function haccpInsert(obj) {
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S070751.jsp"
    				+ '?checklist_id=' + checklist_id
    				+ '&checklist_rev_no=' + checklist_rev_no;
    ...
    function haccpUpdate(obj) {
    	...
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S070752.jsp"
			+ '?checklist_id=' + checklist_id
			+ '&checklist_rev_no=' + checklist_rev_no
			+ '&check_date=' + check_date
    ...
    function haccpDelete(obj) {
    	...
    	function SaveOderInfo() {
   			...
   			if(chekrtn) {
   				SendTojsp(JSONparam, "M838S070750E103");
   			} else {
   				return false;
   			}
    	}
    ...
    function haccpPersonUpdate(obj) {
  	...
  	function haccpPersonDelete(obj) {
    	...
    	function SaveOderInfo() {
    			...
    			if(chekrtn) {
    				SendTojsp(JSONparam, "M838S070750E113");
    			} else{
    			       return false;
    			}
