...
%>
 ...
 <script type="text/javascript">
	var checklist_id = "checklist17";
	var checklist_rev_no = "";
 	var seq_no = "";
 	var regist_date = "";
 	var defect_date = "";
 	
 	var attached_document = "";
 	var file_name = "";
 	var file_path = "";
 	var file_rev_no = "";
 	var regist_no = "";
    ...
    function fn_MainInfo_List(startDate, endDate) {
        $.ajax({
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S070600.jsp",
            data: "From=" + startDate + 
            	  "&To=" + endDate,
    ...
    function displayChecklist(element) {
    	...
    	jObj.checklistDate = defect_date;
    ...
    function haccpInsert(obj) {
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S070601.jsp"
    				+ '?checklist_id=' + checklist_id;
    ...
    function haccpUpdate(obj) {
    	...
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S070602.jsp"
    				+ '?seq_no=' + seq_no;
		var footer = '<button id="btn_Save" class="btn btn-info" onclick="SaveOderInfo();">저장</button>';
		var title = obj.innerText;
		var heneModal = new HenesysModal(url, 'large', title, footer);
    ...
    function haccpDelete(obj) {
    	...
    	function SaveOderInfo() {
   			...
   			if(chekrtn) {
   				SendTojsp(JSONparam, "M838S070600E103");
   			} else {
   				return false;
   			}
    	}
