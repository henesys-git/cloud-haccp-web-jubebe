...
%>
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
    	...
    	var date = new SetRangeDate("dateParent", "dateRange", 90);
		...
		$("#InfoContentTitle").html("소독약품 관리대장");
    ...
    function fn_MainInfo_List(startDate, endDate) {
        $.ajax({
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S020800.jsp",
            data: "From=" + startDate + 
            	  "&To=" + endDate,
    ...
    function fn_DetailInfo_List() {     
    	$.ajax({
   	    	type: "POST",
   	        url: "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S020810.jsp",
    ...
    function haccpInsert(obj) {
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S020801.jsp"
    				+ '?checklist_id=' + checklist_id
    				+ '&checklist_rev_no=' + checklist_rev_no;
    ...
    function haccpDelete(obj) {
    	...
    	function SaveOderInfo() {
   			...
   			if(chekrtn) {
   				SendTojsp(JSONparam, "M838S020800E103");
   			} else {
   				return false;
   			}
    	}
...
///////////////////////////////// 상세 점검 기록
    ...
    function haccpPersonInsert(obj) {
    	...
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S020811.jsp"
    				+ '?checklist_id=' + checklist_id 
    				+ '&checklist_rev_no=' + checklist_rev_no
    ...
    function haccpPersonUpdate(obj) {
    	...
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S020812.jsp"
  	...
  	function haccpPersonDelete(obj) {
    	...
    	function SaveOderInfo() {
    			...
    			if(chekrtn) {
    				SendTojsp(JSONparam, "M838S020800E113");
    			} else{
    			       return false;
    			}
