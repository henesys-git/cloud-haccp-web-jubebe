...
%>
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		$("#InfoContentTitle").html("개선조치 기록부");
    ...
    function fn_MainInfo_List(startDate, endDate) {
        $.ajax({
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S015500.jsp",
            data: "From=" + startDate + 
            	  "&To=" + endDate,
    ...
    function displayChecklist(element) {
    	...
    	if(seq_no.length < 1){
    		heneSwal.warning('조회할 기록부를 선택하세요');
    		return false;
    	}
    ...
    function haccpInsert(obj) {
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S015501.jsp"
    				+ '?checklist_id=' + checklist_id 
    				+ '&checklist_rev_no=' + checklist_rev_no;
    ...
    function haccpUpdate(obj) {
    	...
    	if(seq_no.length < 1){
    		heneSwal.warning('수정할 기록부를 선택하세요');
    		return false;
    	}
    	
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S015502.jsp"
    					+ '?checklist_id=' + checklist_id 
						+ '&checklist_rev_no=' + checklist_rev_no
						+ '&seq_no=' + seq_no
						+ '&unsuit_date=' + unsuit_date
						...
						+ '&improve_action1=' + improve_action
						+ '&improve_action2=' + improve_action2
						+ '&improve_action3=' + improve_action3
						+ '&improve_action4=' + improve_action4
    ...
    function haccpDelete(obj) {
    	...
    	if(seq_no.length < 1){
    		heneSwal.warning('삭제할 기록부를 선택하세요');
    		return false;
    	} else{
    		SaveOderInfo();
    	}
    	...
    	function SaveOderInfo() {
   			...
   			if(chekrtn) {
   				SendTojsp(JSONparam, "M838S015500E103");
   			} else {
   				return false;
   			}
    	}
