...
%>
 ...
 <script type="text/javascript">
    ...
    function fn_MainInfo_List(startDate, endDate) {
        $.ajax({
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S070500.jsp",
            data: "From=" + startDate + 
            	  "&To=" + endDate,
    ...
    function haccpInsert(obj) {
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S070501.jsp"
    ...
    function haccpUpdate(obj) {
    	...
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S070502.jsp"
			+ '?checklist_id=' + checklist_id
			+ '&checklist_rev_no=' + checklist_rev_no
			+ '&check_date=' + check_date
			+ '&check1=' + check1
			+ '&check1_detail=' + check1_detail
			+ '&check2=' + check2
			+ '&check2_detail=' + check2_detail
			+ '&check3=' + check3
			+ '&check3_detail=' + check3_detail
			+ '&check4=' + check4
			+ '&check4_detail=' + check4_detail
			+ '&check5=' + check5
			+ '&check5_detail=' + check5_detail
			+ '&check6=' + check6
			+ '&check6_detail=' + check6_detail
			+ '&check7=' + check7
			+ '&check7_detail=' + check7_detail
			+ '&check8=' + check8
			+ '&check8_detail=' + check8_detail
			+ '&limit_unsuit=' + limit_unsuit
    ...
    function haccpDelete(obj) {
    	...
    	function SaveOderInfo() {
   			...
   			if(chekrtn) {
   				SendTojsp(JSONparam, "M838S070500E103");
   			} else {
   				return false;
   			}
    	}
