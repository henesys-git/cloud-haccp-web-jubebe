...
<%  
/* 
HACCP 연간교육훈련계획서(M838S080100.jsp)
 */
...
%>
 ...
 <script type="text/javascript">
 	...
 	var vDocGubunDefault = "HACCP080";
 	var vDocNoDefault = "HACCP080-100";
    ...
    $(document).ready(function () {
		...
		$("#InfoContentTitle").html("연간 교육 훈련 계획서");
    ...
    function fn_MainInfo_List() {
    	...
    	$.ajax({
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S080100.jsp",
