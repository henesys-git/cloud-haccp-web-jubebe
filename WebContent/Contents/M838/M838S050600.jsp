...
%>
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		$("#InfoContentTitle").html("제조설비 점검 결과");
		...
		$("#InfoContentTitle").html("작업장 점검 결과");
	    fn_MainSubMenuSelect("<%=sMenuTitle%>");        	
	    fn_tagProcess();
    ...
    function fn_MainInfo_List(startDate, endDate) {
       <%--  var from = $("#dateFrom").val();
        ...
        {
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S050600.jsp",
  ...
  //점검정보상세
    function fn_DetailInfo_List() {    	
		...
		{
			type: "POST",
			url: "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S050610.jsp",
...
// 				$("#SubInfo_List_contents").children().remove();
    ...
    function fn_HACCP_View_Canvas(obj) {
    	...
    	var modalContentUrl  = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S050600_canvas.jsp" 
    						 + "?check_date=" + vCheckDate ;					 
    	
    	pop_fn_popUpScr(modalContentUrl, "<%=sMenuTitle%>"+"(S838S050600_canvas)", '800px', '1260px');
		
    	return false;
    }
    
	// 제조설비 점검표 등록(팝업창)
    function pop_fn_PROCESS_Check_Insert(obj) {
		var pageUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S050601.jsp";
    	var paramData = "check_gubun=" + "<%=GV_GET_NUM_PREFIX%>";
    	var pageTitle = obj.innerText+"(S838S050601)";
	...
	<div class="content-header">
      ...
      <div class="col-sm-6">
      	<div class="float-sm-right">
      	  <button type="button" onclick="pop_fn_PROCESS_Check_Insert(this)" id="insert" class="btn btn-outline-dark">제조설비 점검표 등록</button>
      	</div>
       </div>
  		    </div><!-- /.row -->
	    </div><!-- /.container-fluid -->
   ...
   <!--  <div class="panel panel-default" style="margin-left:5px; margin-top:5px; margin-right:5px; margin-bottom:5px; width:100%">
        ...
        <div class="panel-body">
            <div>
	            ...
	            <button data-author="insert" type="button" onclick="pop_fn_PROCESS_Check_Insert(this)" id="insert" class="btn btn-default" 
	            			style="width: auto;float: left; margin-left:30px;">제조설비 점검표 등록</button>
