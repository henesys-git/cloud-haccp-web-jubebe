...
%>
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		$("#InfoContentTitle").html("부자재창고 소독약품 점검일지");
    ...
    function fn_MainInfo_List(startDate, endDate) {
        $.ajax({
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S020750.jsp",
            data: "From=" + startDate + 
            	  "&To=" + endDate,
    ...
    function haccpInsert(obj) {
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S020751.jsp"
    ...
    function haccpUpdate(obj) {
    	...
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S020752.jsp"
			+ '?checklist_id=' + checklist_id
			+ '&checklist_rev_no=' + checklist_rev_no
			+ '&check_date=' + check_date
    ...
    function haccpDelete(obj) {
    	...
    	function SaveOderInfo() {
   			...
   			if(chekrtn) {
   				SendTojsp(JSONparam, "M838S020750E103");
   			} else {
   				return false;
   			}
    	}
    ...
    function haccpPersonUpdate(obj) {
  	...
  	function haccpPersonDelete(obj) {
    	...
    	function SaveOderInfo() {
    			...
    			if(chekrtn) {
    				SendTojsp(JSONparam, "M838S020750E113");
    			} else{
    			       return false;
    			}
