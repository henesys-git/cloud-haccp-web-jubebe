...
%>
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		$("#InfoContentTitle").html("HACCP기준서 정보");

    	fn_MainInfo_List();
        
 	    $("#select_DocGubunCode").on("change", function(){
	    	vDocGubun = $(this).val();
	    	console.log(vDocGubun);
	    	fn_MainInfo_List(vDocGubun);
          ...
          <div class = "card-tools">
	          ...
	          <tr>
	           ...
	           <label> 문서구분 : &nbsp;</label>
 	           ...
 	           <td>
 		           <select class="form-control" id="select_DocGubunCode">
