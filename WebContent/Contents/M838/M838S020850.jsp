...
%>
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		$("#InfoContentTitle").html("작업장 낙하세균 검사 기록");
    ...
    function fn_MainInfo_List(startDate, endDate) {
        $.ajax({
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S020850.jsp",
            data: "From=" + startDate + 
            	  "&To=" + endDate,
    ...
    function haccpInsert(obj) {
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S020851.jsp"
    ...
    function haccpUpdate(obj) {
    	...
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S020852.jsp"
			+ '?check_date=' + check_date;
    ...
    function haccpDelete(obj) {
    	...
    	function SaveOderInfo() {
   			...
   			if(chekrtn) {
   				SendTojsp(JSONparam, "M838S020850E103");
   			} else {
   				return false;
   			}
    	}
