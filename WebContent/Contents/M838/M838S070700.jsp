...
%>
 ...
 <script type="text/javascript">
    ...
    function fn_MainInfo_List(startDate, endDate) {
        $.ajax({
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S070700.jsp",
            data: "From=" + startDate + 
            	  "&To=" + endDate,
    ...
    function fn_DetailInfo_List() {     
    	$.ajax({
   	    	type: "POST",
   	        url: "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S070710.jsp",
   	        data: "seq_no=" + seq_no,
   	        success: function (html) {
    ...
    function haccpUpdate(obj) {
    	...
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S070702.jsp"
			+ '?seq_no=' + seq_no;
    ...
    function haccpDelete(obj) {
    	...
    	function SaveOderInfo() {
   			...
   			dataJson.balju_no = hBaljuNo;
   			dataJson.part_cd = hPartCd;
           	
   			var JSONparam = JSON.stringify(dataJson);
   			var chekrtn = confirm("삭제하시겠습니까?"); 
   			
   			if(chekrtn) {
   				SendTojsp(JSONparam, "M838S070700E103");
   			} else {
   				return false;
   			}
    	}
