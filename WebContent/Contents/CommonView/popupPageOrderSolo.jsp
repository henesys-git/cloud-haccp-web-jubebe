...
<%
	String member_key = "137-86-07935"; // 태양 멤버키
// 	session.setAttribute("member_key",member_key);
...
<table  style="width:100%" id='head_table' >
	<tr>
	   	<td style="width:30%; vertical-align: top; padding-top: 10px; border-bottom: 2px brown solid; padding-left: 30px;" >
	   		<img id="tyens_logo" src="../../images/logo/tyens_logo.jpg" style="width:auto; height:50px;" />
	   	</td>
