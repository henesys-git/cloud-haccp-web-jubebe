...
<%
	...
	String sProgramId =  "";
	String sHeadmenuID=  "";
	String sHeadmenuName=  "";
	String parm=  "";
	
	if(request.getParameter("MenuTitle")== null)
		sMenuTitle="";
	else
		sMenuTitle = request.getParameter("MenuTitle");

	if(request.getParameter("programId")== null)
		sProgramId="";
	else
		sProgramId = request.getParameter("programId");

	if(request.getParameter("HeadmenuID")== null)
		sHeadmenuID="";
	else
		sHeadmenuID = request.getParameter("HeadmenuID");

	if(request.getParameter("HeadmenuName")== null)
		sHeadmenuName="";
	else
		sHeadmenuName = request.getParameter("HeadmenuName");
...
// 	        enctype: "multipart/form-data",
            url: "<%=Config.this_SERVER_path%>/Contents/<%=sHeadmenuID%>/<%=sProgramId%>",
            data: "<%=parm%>" + "&HeadmenuID=<%=sHeadmenuID%>&HeadmenuName=<%=sHeadmenuName%>&MenuTitle=<%=sMenuTitle%>&programId=<%=sProgramId%>",
            beforeSend: function () {
