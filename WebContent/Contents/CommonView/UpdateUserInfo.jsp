...
<%
	...
	DoyosaeTableModel TableModel = new DoyosaeTableModel("M909S080100E304", jArray);
...
<section class="content">
   ...
   <table class="table table-hover">
        ...
        <tr>
            ...
            <td><input type="text" class="form-control" id="txt_UserCode" value="<%=loginID%>" readonly>
           	</td>
        </tr>
        
        <tr>
            <td>이름</td>
            <td><input type="text" class="form-control" id="txt_UserName" value="<%=login_name%>" readonly>
           	</td>
        </tr>
        ...
        <tr>
            <td>휴대폰번호</td>
            <td><input type="text" class="form-control" id="txt_HpNo" value="<%=targetVector.get(2).toString()%>" autocomplete="off"/>
           	</td>
        </tr>
        
        <tr>
            <td>이메일주소</td>
            <td><input type="text" class="form-control" id="txt_Email" value="<%=targetVector.get(3).toString()%>" autocomplete="off"/>
           	</td>
        </tr>
