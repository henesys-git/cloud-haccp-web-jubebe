...
// 		var trNum = $(obj).closest('tr').prevAll().length;//현재 클릭한 TR의 순서 return
    ...
    function fn_DetailInfo_List() {
        ...
        {
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M606/S606S040110.jsp",
        ...
        <div class="panel-body">
        	<div>
	            ...
	            <button data-author="insert" type="button" onclick="pop_fn_JumunInfo_Comlete(this)" id="insert" class="btn btn-default" 
	            			style="width: auto;float: left; margin-left:30px;" >문서배포승인</button>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
	                ...
	                <div id="tabs">
			         	<ul >
			                <li onclick='fn_DetailInfo_List()'><a id="DetailInfo_List"  href=#SubInfo_List_contents>배포문서정보</a></li>
