    ...
    <div class="panel panel-default" style="margin-left:5px; margin-top:5px; margin-right:5px; margin-bottom:5px; width:100%">
        ...
        <div class="panel-body">
        	<div>
	            ...
	            <button data-author="insert" type="button" onclick="pop_fn_JumunInfo_Comlete(this)" id="insert" class="btn btn-default" 
	            			style="width: auto;float: left; margin-left:30px;" >문서양식승인</button>
