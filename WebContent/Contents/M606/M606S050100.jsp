...
// 		var trNum = $(obj).closest('tr').prevAll().length;//현재 클릭한 TR의 순서 return
    ...
    function pop_fn_DocInfo_Insert(obj) {
    	...
    	if(vDocNo.length < 1)
    		modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M606/S606S050100_DocInfo_Insert.jsp?job_gubun=new";
    	else
         	modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M606/S606S050100_DocInfo_Insert.jsp?job_gubun=open &DocNo=" + vDocNo;
    	
		modalFramePopup.setTitle(obj.innerText);
		pop_fn_popUpScr(modalContentUrl, obj.innerText+"(S606S050100_DocInfo_Insert)", "420px", "600px");
		return false;
     }
    ...
    function pop_fn_DocInfo_Update(obj) {
    	...
    	modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M606/S606S050100_DocInfo_update.jsp?DocNo=" + vDocNo ;
    	
		modalFramePopup.setTitle(obj.innerText);
		pop_fn_popUpScr(modalContentUrl, obj.innerText+"(S606S050100_DocInfo_update)", "630px", "680px");
// 		var rtnVal = fn_CommonPopupModal(modalContentUrl, null, 450, 600); modal-md 
    ...
    function pop_fn_DocInfo_Delete(obj) {
    	...
    	modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M606/S606S050100_DocInfo_delete.jsp?DocNo=" + vDocNo ;
    	
		modalFramePopup.setTitle(obj.innerText);
		pop_fn_popUpScr(modalContentUrl, obj.innerText+"(S606S050100_DocInfo_delete)", "150px", "300px");
// 		var rtnVal = fn_CommonPopupModal(modalContentUrl, null, 450, 600); modal-md 
		return false;
    }
