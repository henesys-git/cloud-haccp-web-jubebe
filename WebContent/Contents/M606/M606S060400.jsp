        ...
        <div class="panel-body">
        	<div>
	            ...
	            <button data-author="update" type="button" onclick="pop_fn_JumunInfo_Comlete(this)" id="update" class="btn btn-warning" 
	            			style="width: auto; float: left;  margin-left:30px;">문서폐기승인</button>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
	                ...
	                <div id="tabs">
			         	<ul >
			                <li onclick='fn_DetailInfo_List()'><a id="DetailInfo_List"  href=#SubInfo_List_contents>폐기문서정보</a></li>
