...
// 		var trNum = $(obj).closest('tr').prevAll().length;//현재 클릭한 TR의 순서 return
    ...
    function fn_MainInfo_List() {
        ...
        {
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M606/S606S120100.jsp",
    ...
    function fn_DetailInfo_List() {
        ...
        {
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M606/S606S120110.jsp",
...
// 		}
    	...
    	modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M606/S606S010102.jsp?jspPage=" + '<%=JSPpage%>' 
    			+ "&DocNo=" + vDocNo + "&doc_gubun=" + vDocGubunDefault ;
...
//    	 		}
    	...
    	modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M606/S606S010103.jsp?jspPage=" + '<%=JSPpage%>'
    			+ "&DocNo=" + vDocNo + "&doc_gubun=" + vDocGubunDefault ;
