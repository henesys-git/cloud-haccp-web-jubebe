...
*/	
	...
	DoyosaeTableModel table = new DoyosaeTableModel("M838S015100E144", jArray);
	String data = vtj.vectorToJson(table.getVector());
	
	DoyosaeTableModel table2 = new DoyosaeTableModel("M838S015100E145", jArray);
...
<script>
	...
	$(document).ready(function() {
		...
		bodyObj.body0 = {
		    rowCnt: 6,
		    colCnt: 2,
		    rowRatio: [23/227, 21/227, 19/227, 28/227, 24/227, 112/227],
		...
		bodyObj.body1 = {
		    rowCnt: 10,
		    colCnt: 6,
		    rowRatio: [36/333, 34/333, 34/333, 33/333, 33/333, 32/333, 33/333, 33/333, 33/333, 32/333],
		    colRatio: [58/486, 89/486, 42/486, 54/486, 90/486, 150/486],
		};
		...
		bodyObj.body2 = {
		    ...
		    colCnt: 5,
		    rowRatio: [29/29],
		    colRatio: [147/486, 54/486, 57/486, 57/486, 168/486],
		};

		const cl = new CheckListWithImageBuilder()
		                .setDivId('myCanvas')
		                .setEntireRatio([76/665, 227/665, 333/665, 29/665])
		                .setHeadRowCnt(2)
		                .setHeadColCnt(9)
		                .setHeadRowRatio([22/76, 54/76])
		                .setHeadColRatio([27/486, 36/486, 44/486, 126/486, 89/486, 17/486, 49/486, 48/486, 47/486])
		                .howManyBodies(3)
		...
		bgImg.onload = function() {
			...
			for(let j = 1; j < 8; j++){
				...
				if(j < 5){
					cl.fillText_left(cl.head, "row1", "col"+j, data[2 + j],	'black', "12px arial", 5, 36);	
				} else {
...
<div id="PrintAreaP">
	<canvas id="myCanvas" width="576" height="853">
	</canvas>    
</div>