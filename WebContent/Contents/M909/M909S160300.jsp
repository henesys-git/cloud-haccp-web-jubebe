...
// 	String htmlsideMenu = MainMenu.GetsideMenu(sHeadmenuID,sHeadmenuName);
	...
	Vector optCode =  null;
    Vector optName =  null;
    Vector Process_gubunVector = CommonData.getccpGubun_CodeAll();
...
%>
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {        
		...
		$("#InfoContentTitle").html("HACCP위해요소관리");
    ...
    function fn_MainInfo_List() {
        ...
        {
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M909/S909S160300.jsp",
    ...
    function pop_fn_ProcCd_Insert(obj) {
		...
		pop_fn_popUpScr(modalContentUrl, obj.innerText+"(S909S120101)", "630px", "680px");
		return false;
     }
...
//      if(vProcCd==undefined){
    	...
    	var modalContentUrl;
       	...
       	modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M909/S909S120102.jsp?ProcCd=" + vProcCd + "&RevisionNo=" + vRevisionNo;
...
//      if(vProcCd==undefined){
    	...
    	var modalContentUrl;
       	...
       	modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M909/S909S120103.jsp?ProcCd=" + vProcCd + "&RevisionNo=" + vRevisionNo;
    	
		modalFramePopup.setTitle(obj.innerText);
		pop_fn_popUpScr(modalContentUrl, obj.innerText+"(S909S120103)", "630px", "680px");
// 		var rtnVal = fn_CommonPopupModal(modalContentUrl, null, 450, 600); modal-md 
		return false;
    }
        ...
        <div class="panel-body">
        	<div>
	            <button data-author="mainBtn" type="button"  id="mainButton"  class="btn btn-primary active"
	            			style="width: auto; float: left; ">기준정보-공정코드관리</button>
	            <button data-author="insert" type="button" onclick="pop_fn_ProcCd_Insert(this)" id="insert" class="btn btn-default" 
	            			style="width: auto;float: left; margin-left:30px;" >위해요소코드등록</button>
	            <button data-author="update" type="button" onclick="pop_fn_ProcCd_Update(this)" id="update" class="btn btn-outline-success" 
	            			style="width: auto; float: left; margin-left:3px;">위해요소코드수정</button>
	            <button data-author="delete" type="button" onclick="pop_fn_ProcCd_Delete(this)" id="delete" class="btn btn-danger" 
	            			style="width: auto; float: left; margin-left:3px;">위해요소코드삭제</button>
                ...
                <div style="float: left">
					<table style="width: 100%; text-align:left; background-color:#f5f5f5;">
						<tr>
                           	...
                           	<td style='width:8%; vertical-align: middle'>위해요소구분 :</td>
                            <td style='width:10%;vertical-align: middle'>
	                        	<select class="form-control" id="select_CheckGubunCode" style="width: 150px">
                            ...
                            <td style='width:62%;vertical-align: middle'></td>  
						</tr>
					</table>
				</div>
