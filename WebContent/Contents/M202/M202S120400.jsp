...
// 		tr.attr("style", "background-color:#1c86ee");
    ...
    function fn_MainInfo_List() {
        ...
        {
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S120400.jsp", 
...
//                 $("#MainInfo_List_contents").hide().html(html).fadeIn(100);
	...
	function fn_DetailInfo_List() {     
    	$.ajax(
    	    {
    	        type: "POST",
    	        url: "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S120410.jsp",
    	        data: "PartNo=" + vPartNo ,
    	        beforeSend: function () {
//     	            //$("#SubInfo_List_contents").children().remove();
    	        },
        ...
        <div class="panel-body" >
        	...
        	<div>
	            ...
	            <button data-author="insert" type="button" onclick="pop_Review_Confirm_Insert(this)" id="insert" class="btn btn-default" 
	            			style="width: auto;float: left; margin-left:30px;">반송자재등록승인</button>
            ...
            <div class="panel panel-default">
                ...
                <div id="tabs">
		         	<ul >
		                <li onclick='fn_DetailInfo_List()'><a id="DetailInfo_List"  href=#SubInfo_List_contents>반송자재상세정보</a></li>
