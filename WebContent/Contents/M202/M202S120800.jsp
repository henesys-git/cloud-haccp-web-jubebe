...
// 		tr.attr("style", "background-color:#1c86ee");
    ...
    function fn_MainInfo_List() {
        ...
        {
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S130800.jsp", 
...
//                 $("#MainInfo_List_contents").hide().html(html).fadeIn(100);
	...
	function fn_DetailInfo_List() {     
    	$.ajax(
    	    {
    	        type: "POST",
    	        url: "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S120810.jsp",
    	        data: "PartNo=" + vPartNo ,
    	        beforeSend: function () {
//     	            //$("#SubInfo_List_contents").children().remove();
    	        },
...
<!-- 	            <label style="width: 100px; clear:both; margin-left:3px;"></label> -->
            ...
            <div class="panel panel-default">
                ...
                <div id="tabs">
		         	<ul >
		                <li onclick='fn_DetailInfo_List()'><a id="DetailInfo_List"  href=#SubInfo_List_contents>부적합품상세정보</a></li>
		            </ul>
