...
<%--         makeMenu("<%=htmlsideMenu%>"); --%>
		...
		$("#InfoContentTitle").html("특별관리품목현황");
...
// 		tr.attr("style", "background-color:#1c86ee");
	...
	function fn_DetailInfo_List() {     
    	$.ajax(
    	    {
    	        type: "POST",
    	        url: "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S050110.jsp",
...
<!-- 		                <li >	 <lebel>&nbsp;&nbsp;</lebel></li> -->
<!-- 		                <li class="active" ><a href='#SubInfo_List_contents'>발주상세정보</a></li> -->
