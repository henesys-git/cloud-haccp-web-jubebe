...
<%--         makeMenu("<%=htmlsideMenu%>"); --%>
		...
		$("#InfoContentTitle").html("업체별납기준수현황");
		fn_MainInfo_List();
	    //탭 클릭시 처리하는 Function
	    //$( function() {$( "#tabs" ).tabs();});
...
// 		tr.attr("style", "background-color:#1c86ee");
    ...
    function fn_MainInfo_List() {
        ...
        {
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S050400.jsp", 
...
//                 $("#MainInfo_List_contents").hide().html(html).fadeIn(100);
	...
	function fn_DetailInfo_List() {     
    	$.ajax(
    	    {
    	        type: "POST",
    	        url: "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S050410.jsp",
...
<!-- 	            <label style="width: 100px; clear:both; margin-left:3px;"></label> -->
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
	                ...
	                <div id="tabs">
			         	<ul >
			                <li onclick='fn_DetailInfo_List()'><a id="DetailInfo_List"  href=#SubInfo_List_contents>발주상세정보</a></li>
