...
//     	            //$("#SubInfo_List_contents").children().remove();
    ...
    function pop_fn_incong_Insert(obj) {
    	...
    	modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M808/S808S050101.jsp?OrderNo=" + vOrderNo
				+ "&lotno=" + vLotNo
    			+ "&prod_cd=" + vProd_cd
    			+ "&prod_rev=" + vProd_rev
    	...
    	pop_fn_popUpScr(modalContentUrl, obj.innerText+"(S808S050101)", '550px', '800px');
     }  
...
//     	}
    	...
    	var  modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M808/S808S050102.jsp?OrderNo=" + vOrderNo
				+ "&lotno=" + vLotNo
				+ "&prod_cd=" + vProd_cd
				+ "&prod_rev=" + vProd_rev
				+ "&product_nm=" + vProduct_nm
				...
				+ "&jspPage=" + "<%=JSPpage%>" 
				+ "&num_gubun=<%=GV_GET_NUM_PREFIX%>";
    	pop_fn_popUpScr(modalContentUrl, obj.innerText+"(S808S050102)", '550px', '800px');
     }
...
//     	}
    	...
    	var modalContentUrl;
    	modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M808/S808S050103.jsp?OrderNo=" + vOrderNo
				+ "&lotno=" + vLotNo
				+ "&prod_cd=" + vProd_cd
				+ "&prod_rev=" + vProd_rev
				+ "&product_nm=" + vProduct_nm
				...
				+ "&jspPage=" + "<%=JSPpage%>" 
				+ "&num_gubun=<%=GV_GET_NUM_PREFIX%>";
    	pop_fn_popUpScr(modalContentUrl, obj.innerText+"(S808S050103)", '550px', '800px');
     }
    ...
    function pop_fn_JumunInfo_Comlete(obj) {
    	...
    	var modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M808/S808S050122.jsp?OrderNo=" + vOrderNo
		+ "&lotno=" + vLotNo
		+ "&prod_cd=" + vProd_cd
		+ "&prod_rev=" + vProd_rev
		+ "&product_nm=" + vProduct_nm
