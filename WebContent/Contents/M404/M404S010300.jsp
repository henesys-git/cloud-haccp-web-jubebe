    	...
    	$.ajax(
    	    {
    	        ...
    	        data: "OrderNo=" + vOrderNo + "&JSPpage=" + '<%=JSPpage%>',
        ...
        <div class="panel-body" >
        	...
        	<div>
	            ...
	            <button data-author="insert" type="button" onclick="pop_Review_Confirm_Insert(this)" id="insert" class="btn btn-default" 
	            			style="width: auto;float: left; margin-left:30px;">수입검사검토</button>
                    ...
                    <div style="float: left">
                        <table style="width: 100%; text-align:left; background-color:#e9e9e9;">
                            ...
                            <td style='width:15%; vertical-align: middle;'>
                            	...
                            	<td style='width:6%; vertical-align: middle'>검사일자 : </td>
...
<!--                                 </td>                                 -->
                                ...
                                <td style="width:62%; text-align:left">
                                    ...
                                    <button type="button" onclick="fn_MainInfo_List()" id="btn_Search" class="btn btn-outline-success"
                                        style="width: 110px; margin-left: 3px;">조회</button>
                                </td>
                            </tr>
                        </table>
                        <p>
