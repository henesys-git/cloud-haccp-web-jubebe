    ...
    function fn_DetailInfo_List() { 
    	<%-- 		if(vBaljuNo.length < 1){
    	    	...
    	    	$.ajax(
    	    	    {
    	    	        type: "POST",
    	    	        url: "<%=Config.this_SERVER_path%>/Contents/Business/M404/S404S010710.jsp",
    	    	        data: "order_no=" + vOrderNo + "&BaljuNo=" + vBaljuNo ,
    	    	        beforeSend: function () {
//    	     	            //$("#SubInfo_List_contents").children().remove();
    	    	        },
    	    	        success: function (html) {
    	...
    	<div class="card-body">
    		<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
	       		<li class="nav-item" onclick='fn_DetailInfo_List()'>
	       			<a class="nav-link" id="DetailInfo_List" data-toggle="pill" href="#SubInfo_List_contents" role="tab">수입검사성적서</a>
	       		</li>
	        </ul>
...
<!--                                         협력사검색</button>  -->
                ...
                <div id="tabs">
			        <ul >
			            <li onclick='fn_DetailInfo_List()'><a id="DetailInfo_List"  href=#SubInfo_List_contents>수입검사성적서</a></li>
			        </ul>
