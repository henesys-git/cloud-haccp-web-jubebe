...
%>
 ...
 <script type="text/javascript">
 	...
 	var vDocNoDefault = "NORML001-200";
    ...
    $(document).ready(function () {
		...
		$("#InfoContentTitle").html("수입 검사 성적서 목록");
	...
	<div class="content-header">
      ...
      <div class="col-sm-6">
      	<div class="float-sm-right">
      	  <button type="button" onclick="pop_fn_DocInfo_Insert(this)" id="insert" class="btn btn-outline-dark">성적서등록</button>
      	  <button type="button" onclick="pop_fn_DocInfo_Update(this)" id="update" class="btn btn-outline-success">성적서수정</button>
      	  <button type="button" onclick="pop_fn_DocInfo_Delete(this)" id="delete" class="btn btn-outline-danger">성적서삭제</button>
