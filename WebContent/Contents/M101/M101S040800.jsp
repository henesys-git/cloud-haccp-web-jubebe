        ...
        <div class="panel-body">
            <div>
	            <button data-author="mainBtn" type="button"  id="mainButton"  class="btn btn-primary active"
	            			style="width: auto; float: left; ">납품납품관리-납품정보</button>
<!-- 	            <button data-author="insert" type="button" onclick="pop_fn_JumunInfo_Insert(this)" id="insert" class="btn btn-default"  -->
<!-- 	            			style="width: auto;float: left; margin-left:30px;">납품기본정보등록</button> -->
<!-- 	            <button data-author="insert" type="button" onclick="pop_fn_JumunProduct_Insert(this)" id="insert" class="btn btn-warning"  -->
<!-- 	            			style="width: auto; float: left; margin-left:3px;">납품제품등록</button> -->
<!-- 	            <button data-author="update" type="button" onclick="pop_fn_JumunProduct_Update(this)" id="update" class="btn btn-outline-success"  -->
<!-- 	            			style="width: auto; float: left; margin-left:3px;">납품제품수정</button> -->
<!-- 	            <button data-author="delete" type="button" onclick="pop_fn_JumunProduct_Delete(this)" id="delete" class="btn btn-danger"  -->
<!-- 	            			style="width: auto; clear:both;  margin-left:3px;">납품제품삭제</button> -->
...
<!-- 	                <div id="tabs"> -->
<!-- 			         	<ul > -->
<!-- 			                <li onclick='fn_DetailInfo_List()'><a id="DetailInfo_List"  href=#SubInfo_List_contents>납품상세정보(제품 정보)</a></li> -->
