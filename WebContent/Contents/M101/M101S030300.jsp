...
%>
 ...
 <script type="text/javascript">
    ...
    var GV_QUEUE_ORDERNO="";
    var GV_QUEUE_ORDERNO_DT="";
...
//         var custcode = $("#txt_cust_code").val().toString(); 
        ...
        $.ajax(
        {
            ...
            data: "custcode=" + custcode + "&OrderNo=" + vOrderNo + "&OrderDetailSeq="	+ vOrderDetailSeq + "&LotNo=" + vLotNo ,
            beforeSend: function () {
                //$("#SubInfo_List_contents").children().remove();
            },
            success: function (html) {
        	...
        	<div style="width:100%;">
	        	<div >
		            ...
		            <button data-author="insert" type="button" onclick='pop_Review_Confirm_Insert(this)' id="insert" class="btn btn-default" 
		            			style="width: auto; clear:both;  margin-left:30px;">기술문서등록검토</button>
	            </div>
	            ...
	            <div class="panel panel-default">
	                ...
	                <div id="tabs">
			         	<ul >
			                ...
			                <li onclick='com_fn_SubInfo_DOC_List(this,vOrderNo)'><a id="SubInfo_DOC_List"  href='#SubInfo_List_contents'>주문문서목록</a></li>
			                ...
			                <li onclick='pop_fn_ProducCheckList(this)'><a id="Subinfo_prod_checkList"  href='#Subinfo_Process_check'>제품검사체크리스트</a></li>
			                <li id="Total_Info"></li>
			            </ul>
