...
<%--         makeMenu("<%=htmlsideMenu%>"); --%>
		...
		$("#InfoContentTitle").html("부적합품검사신청정보");
...
// 		tr.attr("style", "background-color:#1c86ee");
    ...
    function fn_MainInfo_List() {
        ...
        {
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M303/S303S090100.jsp", 
...
//                 $("#MainInfo_List_contents").hide().html(html).fadeIn(100);
	...
	function fn_DetailInfo_List() {     
    	$.ajax(
    	    {
    	        type: "POST",
    	        url: "<%=Config.this_SERVER_path%>/Contents/Business/M303/S303S090110.jsp",
...
//     	            //$("#SubInfo_List_contents").children().remove();
    ...
    function pop_fn_BauljuInfo_Insert(obj) {
    	...
    	modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S010101.jsp";
		modalFramePopup.setTitle(obj.innerText);
		pop_fn_popUpScr(modalContentUrl, obj.innerText+"(S202S010101)", "430px", "800px");
     }    
    //발주서수정
    function pop_fn_BauljuInfo_Update(obj) {
    	var modalContentUrl;
    	
    	modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S010102.jsp";
		modalFramePopup.setTitle(obj.innerText);
		pop_fn_popUpScr(modalContentUrl, obj.innerText+"(S202S010102)", "430px", "800px");
     }
    //발주원부자재등록
    function pop_fn_Baulju_Part_Insert(obj) {
    	var modalContentUrl;
    	
    	modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S010111.jsp";
		modalFramePopup.setTitle(obj.innerText);
		pop_fn_popUpScr(modalContentUrl, obj.innerText+"(S202S010111)", "430px", "800px");
     }
    
    //발주원부자재수정
    function pop_fn_Baulju_Part_Update(obj) {
    	var modalContentUrl;
    	
    	modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S010112.jsp";
		modalFramePopup.setTitle(obj.innerText);
		pop_fn_popUpScr(modalContentUrl, obj.innerText+"(S202S010112)", "430px", "800px");
     }
    //발주서삭제
    function pop_fn_BauljuInfo_Delete(obj) {
    	var modalContentUrl;
    	
    	modalContentUrl = "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S010103.jsp";
		modalFramePopup.setTitle(obj.innerText);
		pop_fn_popUpScr(modalContentUrl, obj.innerText+"(S202S010103)", "430px", "800px");
     }
    </script>
            ...
            <div class="panel panel-default">
                ...
                <div id="tabs">
		         	<ul id="ProcessInfoSubMenuSearch" role="tablist" class="nav nav-tabs" style="font-size:16px; font-weight: bold">
		                <li >	 <lebel>&nbsp;&nbsp;</lebel></li>
		                <li class="active" ><a href='#SubInfo_List_contents'>부적합품검사신청상세정보</a></li>
