...
<%
	...
	if(request.getParameter("uploadChecklistNum") != null) 
		documentNum = request.getParameter("uploadChecklistNum");
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
      	<div class="float-sm-right">
			...
			<button type="button" id="view-btn" class="btn btn-outline-warning">
				점검표조회
			</button>
