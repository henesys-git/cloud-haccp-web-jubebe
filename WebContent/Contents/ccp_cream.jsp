    	...
    	<div class="row mb-2">
	      	...
	      	<div class="col-md-3 form-group">
				...
				<select class="form-control w-auto d-inline-block" id="sensor-type" name="sensor-type">
					<option value="CR%25">전체</option>
				</select>
	      	</div>
			<div class="col-md-3">
		      	<div class="form-check-inline">
				    <label class="form-check-label">
				      <input type="radio" class="form-check-input" name="test-yn" value="PC80" checked>운영
				    </label>
				</div>
				<div class="form-check-inline">
				    <label class="form-check-label">
				      <input type="radio" class="form-check-input" name="test-yn" value="PC85" disabled>테스트
				    </label>
				</div>
       	  	</div>
