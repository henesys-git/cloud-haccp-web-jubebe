...
<%-- 	<script type="text/javascript" src="<%=Config.this_SERVER_path%>/AdminLTE-3.0.5/bower_components/chart.js/Chart.js"></script>  --%>
<style>
	canvas {
...
// 			console.log("Contents/Business/M707/S707S010205.jsp");
			$container.load("<%=Config.this_SERVER_path%>/Contents/Business/M707/S707S010205.jsp?From=" + from + "&To=" + to   +"&Chart_Style=" + vChart_Style);
		}, 60000);
    });
    ...
    function fn_refres_chart(){
    	fn_clearList();
//     	window.docLineChart.reset();
    	fn_MainInfo_List();
    }
...
//         }
    ...
    function fn_MainInfo_List() {
        ...
        {
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M707/S707S010205.jsp", 
    ...
    <div class="panel panel-default" style="margin-left:5px; margin-top:5px; margin-right:5px; margin-bottom:5px; width:100%" >
        ...
        <div class="panel-body" >        
        	<div style="display: table-cell;vertical-align:middle;">
	            ...
	            <label style="width:auto ; float: left; margin-left:3px; margin-top:8px;">모니터링 시작일</label>
				...
				<label style="width:auto ; float: left; margin-left:3px;margin-top:8px;">~ 오늘</label>
				...
				<button type="button" onclick="fn_refres_chart()" id="btn_Search" class="btn btn-outline-success" 
...
<!--             	<input type="radio"  id="rdo_QA_report2"  name="Chart_Style" value="radar" style="margin-left:20px;margin-top:12px;">Radar</input> -->
            	</p>
            </div>
