...
// 	var barChartData = [] ;
	...
	$(document).ready(function () {
		...
		$("#InfoContentTitle").html("일별 제품원가 현황");
		fn_MainInfo_List();
	    //탭 클릭시 처리하는 Function
	    //$( function() {$( "#tabs" ).tabs();});
...
// 			vChart_Style = $(':input[name="Chart_Style"]:radio:checked').val();
    ...
    function fn_MainInfo_List() {
        ...
        $.ajax(
        {
            ...
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M707/S707S020300.jsp", 
            data: "From=" + from + "&To=" + to +"&Chart_Style=" + vChart_Style ,
            beforeSend: function () {
//             	alert("vChart_Style : " + vChart_Style);
                $("#MainInfo_List_contents").children().remove();
            },
...
<!--                             		<div class="panel-heading" style="font-size:16px; font-weight: bold"  id="InfoContentTitle"></div> -->
                            	...
                            	<td style='width:5%; vertical-align: middle'>생산시작일자 :</td>
                                <td style='width:6%;  vertical-align: middle'>
                                    <input type="text" data-date-format="yyyy-mm-dd" id="dateFrom" class="form-control" />
                                </td>
                                <td style='width:1%;vertical-align: middle'>
