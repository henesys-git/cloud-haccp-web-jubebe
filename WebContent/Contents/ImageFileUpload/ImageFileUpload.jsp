...
// 해쉬테이블
	...
	// 업로드용 폴더 이름
	String saveFolder =  "/images/SULBI";  
...
// 		enumer = multipart.getFileParameterNames();
		while(enumer.hasMoreElements()) {
			...
			String SulbiCode = String.valueOf(hashObject.get("SulbiCode", HashObject.YES));
			String ext = String.valueOf(hashObject.get("ext", HashObject.YES)); 
			...
			if(multipart.getFile(name) != null) {
				...
				File renameFile = new File(realFolder + "/" + SulbiCode + "." + ext);	
				renameFile.delete();
