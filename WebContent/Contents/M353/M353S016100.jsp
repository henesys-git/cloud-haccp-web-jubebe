...
%>
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		$("#InfoContentTitle").html("부자재수불일보목록");
    ...
    function fn_MainInfo_List() {
        ...
        {
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M353/S353S016100.jsp",
// 	        data: "SeolbiCd=" + vSeolbiCd ,
			data: "From=" + from + "&JSPpage=" + '<%=JSPpage%>' + "&custcode=" ,
            beforeSend: function () {
    ...
    //공정수불정보 엑셀/프린트 button
    function fn_excel_List() {
    	var from = $("#dateFrom").val();
    	
        $.ajax(
        {
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M353/S353S016120.jsp",
// 	        data: "SeolbiCd=" + vSeolbiCd ,
			data: "From=" + from + "&JSPpage=" + '<%=JSPpage%>' + "&custcode=" ,
            beforeSend: function () {
                $("#MainInfo_List_contents").children().remove();
	...
	function fn_DetailInfo_List() {
    	$.ajax(
    	    {
    	        type: "POST",
    	        url: "<%=Config.this_SERVER_path%>/Contents/Business/M353/S353S016110.jsp",
        ...
        <div class="panel-body" >
        	...
        	<div>
	            <button data-author="mainBtn" type="button"  id="mainButton"  class="btn btn-primary active"
	            			style="width: auto; float: left; ">공정관리-원료수불일보</button>
                    ...
                    <div style="float: left">
                        <table style="width: 100%; text-align:left; background-color:#e9e9e9;">
                            <tr><td style='width:15%; vertical-align: middle;'>
                            	...
                            	<td style='width:2%; vertical-align: middle'>일자 :</td>
...
<!--                                         협력사검색</button>  -->
                                    ...
                                    <button data-author="insert" type="button" onclick="fn_excel_List(this)" id="insert" class="btn btn-default" 
	            			  				style="width: auto;float: left; margin-left:15px;">엑셀/프린트</button>
<!--                                     <button type="button" onclick="fn_excel_List()" id="btn_Search" class="btn  btn-outline-success" style='width:110px; margin-left:30px;float:left'>엑 셀</button> -->
                                 </td>  
