...
%>
 ...
 <script type="text/javascript">
	...
	$(document).ready(function () {
		...
		$("#InfoContentTitle").html("출하운송실적목록");
    ...
    function fn_MainInfo_List() {
        ...
        {
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M858/S858S030200.jsp",
...
<!--                 <div id="tabs"> -->
<!-- 		         	<ul > -->
<!-- 	                	<li onclick='fn_DetailInfo_List()'><a id="DetailInfo_List"  href='#SubInfo_List_contents'>운송목록</a></li> -->
<!-- 		                <li onclick='fn_BaechaInfo_List()'><a id="BaechaInfo_List"  href='#SubInfo_List_contents'>배차목록</a></li> -->
<!-- 		            </ul> -->
