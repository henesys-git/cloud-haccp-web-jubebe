...
%>
 ...
 <script type="text/javascript">
 	...
 	var vDocNoDefault = "NORML001-300";
    ...
    $(document).ready(function () {
		...
		$("#InfoContentTitle").html("거래명세서 대장 목록");
    ...
    function fn_MainInfo_List() {
        ...
        $.ajax({
            type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M404/S404S010700.jsp",
    ...
    <%-- function pop_fn_DocInfo_Revision(obj) {
    	...
    	var url = "<%=Config.this_SERVER_path%>/Contents/Business/M606/S606S010122.jsp"
    					+ "?RegistNo=" + vRegistNo + "&RevisionNo=" + vRevisionNo 
    					+ "&DocumentNo=" + vDocumentNo + "&FileViewName=" + vFileViewName
						+ "&jspPage=" + '<%=JSPpage%>';
						
		var footer = "";
		var title  = obj.innerText;
		var heneModal = new HenesysModal(modalContentUrl, 'standard', title+"(S606S010122)", footer);
		heneModal.open_modal();   
	} --%>
</script>
	...
	<div class="content-header">
      ...
      <div class="col-sm-6">
      	<div class="float-sm-right">
      	  <button type="button" onclick="pop_fn_DocInfo_Insert(this)" id="insert" class="btn btn-outline-dark">명세서 등록</button>
      	  <button type="button" onclick="pop_fn_DocInfo_Update(this)" id="update" class="btn btn-outline-success">명세서 수정</button>
      	  <button type="button" onclick="pop_fn_DocInfo_Delete(this)" id="delete" class="btn btn-outline-danger">명세서 삭제</button>
