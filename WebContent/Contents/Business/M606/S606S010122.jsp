 ...
 */
	...
	String GV_REGIST_NO="", GV_DOCUMENT_NO="", GV_FILEVIEW_NAME="",GV_LOTNO;
	...
	if(request.getParameter("LotNo")== null)//2019-01-12 jh 추가
		GV_LOTNO="";
	else
	...
	String HACCP_DOC_GB ="";
	if( GV_JSPPAGE.indexOf("838")>0)
		HACCP_DOC_GB = "838"; //HACCP 문서관리관련 Page인 경우
	else
		HACCP_DOC_GB = "606"; //"606":일반문서관리관련 Page인  인 경우 구분
...
//	}
	...
	String param = GV_REGIST_NO + "|" + GV_REVISION_NO + "|" + GV_DOCUMENT_NO + "|" 
				+ GV_FILEVIEW_NAME + "|" + member_key + "|" + HACCP_DOC_GB + "|";
...
%>
    ...
    function submitForm(){
        ...
        data.append("lotno", 		"<%=GV_LOTNO%>");//2019-01-12 jh 추가
    	...
    	if ($('#idFilename').val().length < 1) {
    		...
    		var work_complete_update_check = confirm("개정하시겠습니까?");
    	        ...
    	        success: function (data) {
					...
					if(data.length>0){}
                    	...
                    	alert("개정 되었습니다.");
                 		...
                 		parent.com_fn_SubInfo_DOC_List(this,vOrderNo);
 ...
 -->	        
	        ...
	        <tr style="height: 60px">
	            <td colspan="2" align="center">
                    ...
                    <button id="btn_Canc"  class="btn btn-info" style="width: 100px" onclick="$('#modalReport').modal('hide');return false;">취소</button>
	                </p>
	            </td>
	        </tr>
    	</tbody>
