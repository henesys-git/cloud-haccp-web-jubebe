...
// 	final int PageSize=15; 
	...
	String[] TR_Style		= {""," onclick='S606S040800Event(this)' "};
    ...
    TableModel = new EdmsDoyosaeTableModel("M606S040100E804", strColumnHead, param);	
    ...
    makeTableHTML.htmlTable_ID	= "TableS606S040800";
...
// 		{"문서코드", "문서명", "문서구분코드", "문서구분", "파일명","등록번호","변경번호", "실파일명"  ,"외부문서", "등록사유", "파기사유","총페이지", "관리본여부","보관여부","보존여부","배포일자", "배포자","document_no_rev"} ;
