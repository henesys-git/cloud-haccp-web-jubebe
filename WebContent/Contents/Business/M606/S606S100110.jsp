...
// 	DateTimeUtil dateTimeUtil = new DateTimeUtil();
	...
	String[] TR_Style		= {""," onclick='S606S100100Event(this)' "};
    ...
    makeTableHTML.htmlTable_ID	= "TableS606S100110";
...
// 		{"문서코드", "문서명", "문서구분코드", "구분명", "파일명","등록번호","변경번호", "실파일명"  ,"외부문서", "등록사유", "파기사유","총페이지", "관리본여부","보관여부","보존여부"} ;	
		...
		var document_no_rev 	= td.eq(0).text().trim();
		var JSPpage			= '<%=JSPpage%>';
		var loginID			= '<%=loginID%>';
