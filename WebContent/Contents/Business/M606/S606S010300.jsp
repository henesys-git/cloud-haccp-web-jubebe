...
// 	final int PageSize=15; 
	...
	String[] strColumnHead 	= {"문서코드", "문서명", "문서구분코드", "문서구분", "파일명","등록번호","변경번호", "실파일명"  ,"외부문서", "등록사유", "파기사유","총페이지", "관리본여부","보관여부","보존여부","검토일자", "검토자","document_no_rev"} ;	
	int[]   colOff 			= {0         , 9      , 0              , 8         , 8       , 5        , 5        , 8           , 5        , 5         , 5         , 5        , 5           , 5        , 5        , 11        , 5, 0};//전체 넓이 번튼 3개:86%, 문서2개:90%, 문서뷰:94%, 챠트보기,문서등록91%;
	String[] TR_Style		= {""," onclick='S606S010300Event(this)' "};
    ...
    TableModel = new EdmsDoyosaeTableModel("M606S010100E304", strColumnHead, param);	
    ...
    makeTableHTML.htmlTable_ID	= "TableS606S010300";
...
// 		{"문서코드", "문서명", "문서구분코드", "문서구분", "파일명","등록번호","변경번호", "실파일명"  ,"외부문서", "등록사유", "파기사유","총페이지", "관리본여부","보관여부","보존여부","검토일자", "검토자","document_no_rev"} ;	
