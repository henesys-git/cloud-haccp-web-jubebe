...
<%
	...
	String[] TR_Style		= {"",""};
// 	String[] TR_Style		= {""," onclick='S404S070130Event(this)' "};
    ...
    TableModel = new DoyosaeTableModel("M404S030100E134", strColumnHead, jArray);	
...
//     makeTableHTML.htmlTable_ID	= "TableS404S070130";
...
var vTableS404S070130;
var TableS404S070130_info;
var TableS404S070130_RowCount;
var S404S070130_Row_index = -1;

var item_type = [];


    $(document).ready(function () {	
		vTableS404S070130=$('#order_product_result_table').DataTable({    	    
			scrollX: true,
			scrollY: 470,
		    scrollCollapse: true,
		    paging: false,
...
// 			S404S070130_Row_index = vTableS404S070130
// 		        .row( this )
// 		        .index();		
// 		});
...
// 				alert($(this).closest('tr').preveAll().length);
		 		$($("input[id='txt_item_type']")[S404S070130_Row_index]).on("click", function(){
					if($($("input[id='txt_item_type']")[S404S070130_Row_index]).prop('checked')){
						$(this).attr("checked", true);
						item_type[S404S070130_Row_index]="Y";
	//						$($("input[id='txt_pass_yn']")[S404S070130_Row_index]).attr("checked", true);
		 			}
					else{
						$(this).attr("checked", false);
						item_type[S404S070130_Row_index]="N";
						
	//						$($("input[id='txt_pass_yn']")[S404S070130_Row_index]).attr("checked", false);
					}	
			    }); 			
			});
...
// 			vTableS404S070130.row(this)
// 		    .nodes()
// 		    .to$()
// 		    .attr("class", "hene-bg-color_w");
// 		} );

    function S404S070130Event(obj){
    	var tr = $(obj);
		var td = tr.children();
...
<%for (int i=0; i<RowCount; i++){  %>	        
	        ...
	        <tr style="vertical-align: middle">			            
	           ...
	           <td style="text-align:center; vertical-align: middle ;margin: 0 ;">
	            ...
	            <td style="text-align:center; vertical-align: middle ;margin: 0 ;">
					<input type="checkbox" id="txt_pass_yn" value="CHECK" disabled="disabled">합격여부</input>
	           	</td>
	           	<td style="text-align:center; vertical-align: middle ;margin: 0 ;">
