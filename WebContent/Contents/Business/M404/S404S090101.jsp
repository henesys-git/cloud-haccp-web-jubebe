		...
		<td style="width: 47%;">
   			<table class="table table-bordered" style="width: 100%; margin: 0 auto; align:left">
				...
				<tr style="background-color: #fff;">
		            ...
		            <td >
		            	<input type="text" data-date-format="yyyy-mm-dd" id="dateOrder" class="form-control" style="width: 150px; border: solid 1px #cccccc;"/>
		         	</td>
		            <td style=" font-weight: 900; font-size:14px; text-align:left">납기일자</td>
		            <td> 
		            	<input type="text" data-date-format="yyyy-mm-dd" id="dateDelevery" class="form-control" style="width: 150px; border: solid 1px #cccccc;"/>
		            </td>
		        </tr>
		        ...
		        <tr style="background-color: #fff; ">
		            ...
		            <td>
		            	<input type="text"  id="txt_productSerialNo" class="form-control" style="width: 150px; border: solid 1px #cccccc; vertical-align: middle;"/>
		            </td>
		            <td style=" font-weight: 900; font-size:14px; text-align:left">고객사PoNo</td>
		            <td> 
		            	<input type="text"  id="txt_cust_poNo" class="form-control" style="width: 150px; border: solid 1px #cccccc; vertical-align: middle;"/>
		            </td>
		        </tr>
		        ...
		        <tr style="background-color: #fff; ">
		         	<td>프로젝트수량</td>
		            <td>
		            	<input type="text"  id="txt_projrctCnt" class="form-control" style="width: 150px; border: solid 1px #cccccc; vertical-align: middle;"/>
		            </td>
		            <td style=" font-weight: 900; font-size:14px; text-align:left">주문 수량</td>
		            <td>
		            	<input type="text"  id="txt_jumunCount" class="form-control" style="width: 150px; border: solid 1px #cccccc; vertical-align: middle;"/>
		            </td>
