...
// 	final int PageSize=15; 
	...
	String GV_ORDERNO="",GV_LOTNO="",GV_INSPECT_GUBUN="",GV_PRODUCT_SERIAL_NO="",GV_PRODUCT_SERIAL_NO_END="";
	...
	String param = ""  + GV_ORDERNO + "|" + GV_LOTNO + "|" + GV_INSPECT_GUBUN + "|" + GV_PRODUCT_SERIAL_NO + "|" + GV_PRODUCT_SERIAL_NO_END + "|";
    ...
    TableModel = new DoyosaeTableModel("M404S070100E114", jArray);
    ...
    makeGridData.htmlTable_ID	= "tableS404S070110";
...
<table class='table table-bordered nowrap table-hover' id="<%=makeGridData.htmlTable_ID%>" style="width: 100%">
		...
		<% if(GV_TABLET_NY.equals("Tablet")) { %>
		     ...
		     <th>체크구분</th>
		     <th style='width:0px; display: none;'>초품코드</th>
