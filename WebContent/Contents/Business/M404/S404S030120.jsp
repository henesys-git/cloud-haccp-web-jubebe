...
//     makeTableHTML.htmlTable_ID	= "TableS404S070120";
...
var vTableS404S070120;
var TableS404S070120_info;
var TableS404S070120_RowCount;
var S404S070120_Row_index = -1;

var item_type = [];


    $(document).ready(function () {	
		vTableS404S070120=$('#order_product_result_table').DataTable({   
			scrollX: true,
			scrollY: 470,
		    scrollCollapse: true,
		    paging: false,
...
// 			S404S070120_Row_index = vTableS404S070120
// 		        .row( this )
// 		        .index();		
// 		});
...
// 				alert($(this).closest('tr').preveAll().length);
		 		$($("input[id='txt_item_type']")[S404S070120_Row_index]).on("click", function(){
					if($($("input[id='txt_item_type']")[S404S070120_Row_index]).prop('checked')){
						$(this).attr("checked", true);
						item_type[S404S070120_Row_index]="Y";
	//						$($("input[id='txt_pass_yn']")[S404S070120_Row_index]).attr("checked", true);
		 			}
					else{
						$(this).attr("checked", false);
						item_type[S404S070120_Row_index]="N";
						
	//						$($("input[id='txt_pass_yn']")[S404S070120_Row_index]).attr("checked", false);
					}	
			    }); 			
			});
...
// 			vTableS404S070120.row(this)
// 		    .nodes()
// 		    .to$()
// 		    .attr("class", "hene-bg-color_w");
// 		} );

    function S404S070120Event(obj){
    	var tr = $(obj);
		var td = tr.children();
