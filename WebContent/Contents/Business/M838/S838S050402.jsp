...
<!-- <form id="mesfrm"> -->
   <table class="table table-hover" style="width: 100%; margin: 0 auto; align:left">      
        ...
        <tr style="background-color: #fff; height: 40px">
            ...
            <td> </td>
            <td >
            	<input type="text" class="form-control" id="txt_extnl_in_conpany" style="width: 300px; float:left" 
        ...
        <tr style="background-color: #fff; height: 40px">
            ...
            <td> </td>
            <td >
            	<input type="text" class="form-control" id="txt_extnl_in_title" style="width: 300px; float:left" 
        ...
        <tr style="background-color: #fff; height: 40px">
            ...
            <td> </td>
            <td >
            	<input type="text" class="form-control" id="txt_extnl_in_cust_name" style="width: 300px; float:left" 
