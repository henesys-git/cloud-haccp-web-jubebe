...
//  웹소켓 통신을 위해서 필요한 변수들 ---끝	
    var detail_seq=1;
   	var vproduct_person_delete_table;
    var vproduct_person_delete_table_Row_index = -1;
	var vproduct_person_delete_table_info;
    var vproduct_person_delete_table_RowCount=0;
   	var vproduct_product_delete_table;
    var vproduct_product_delete_table_Row_index = -1;
	var vproduct_product_delete_table_info;
    var vproduct_product_delete_table_RowCount=0;
   	var vproduct_permission_delete_table;
    var vproduct_permission_delete_table_Row_index = -1;
	var vproduct_permission_delete_table_info;
    var vproduct_permission_delete_table_RowCount=0;
   	var vproduct_equipment_delete_table;
    var vproduct_equipment_delete_table_Row_index = -1;
	var vproduct_equipment_delete_table_info;
    var vproduct_equipment_delete_table_RowCount=0;
        
    
    $(document).ready(function () {
    	detail_seq=1;
		// 인원현황 테이블
	    vproduct_person_delete_table = $('#person_table').DataTable({
	    	scrollX: true,
		    scrollY: 250,
// 		    scrollCollapse: true,
		    paging: false,
    	...
    	// 생산능력 테이블
	    vproduct_product_delete_table = $('#product_table').DataTable({
	    	scrollX: true,
		    scrollY: 250,
// 		    scrollCollapse: true,
		    paging: false,
	    ...
	    // 허가관계 테이블
	    vproduct_permission_delete_table = $('#permission_table').DataTable({
	    	scrollX: true,
		    scrollY: 250,
// 		    scrollCollapse: true,
		    paging: false,
	    ...
	    // 설비현황 테이블
	    vproduct_equipment_delete_table = $('#equipment_table').DataTable({
	    	scrollX: true,
		    scrollY: 250,
// 		    scrollCollapse: true,
		    paging: false,
        ...
        for(var i=0; i<vproduct_permission_delete_table_RowCount; i++){	            
        ...
        $('#txt_EndDate').datepicker('update', today);
...
<%-- 		
        ...
        vproduct_person_delete_table_info = vproduct_person_delete_table.page.info();
        vproduct_person_delete_table_RowCount = vproduct_person_delete_table_info.recordsTotal;        
        vproduct_product_delete_table_info = vproduct_product_delete_table.page.info();
     	vproduct_product_delete_table_RowCount = vproduct_product_delete_table_info.recordsTotal;        
     	vproduct_permission_delete_table_info = vproduct_permission_delete_table.page.info();
     	vproduct_permission_delete_table_RowCount = vproduct_permission_delete_table_info.recordsTotal;
     	vproduct_equipment_delete_table_info = vproduct_equipment_delete_table.page.info();
     	vproduct_equipment_delete_table_RowCount = vproduct_equipment_delete_table_info.recordsTotal;
	...
	function SetRecvData(){
		DataPars(M838S060200E103, GV_RECV_DATA);  	
 		if(M838S060200E103.retnValue > 0)
 			alert('등록 되었습니다.');
	...
	function SaveOderInfo() {      
        ...
        for(var i=0; i<vproduct_person_delete_table_RowCount;i++){
...
<%--     	jsonPerson.member_key			= '<%=member_key%>'; --%>
        ...
        for(var i=0; i<vproduct_product_delete_table_RowCount;i++){
...
<%--     	jsonPermission.member_key			= '<%=member_key%>'; --%>
        ...
        for(var i=0; i<vproduct_equipment_delete_table_RowCount;i++){
...
//    	console.log("??? : " + user_id +" ~ "+ revision_no + " ~ " + user_nm);
    ...
    function fn_plus_person_body(){
    	vproduct_person_delete_table.row.add( [
    		"	<input type='text' class='form-control' id='txt_detail_seq'  style='width:30px;' readonly></input>",
    		"	<input type='text' class='form-control' id='txt_personDivision"+ vproduct_person_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_personPeople"+ vproduct_person_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_personDesk"+ vproduct_person_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_personTechnicial"+ vproduct_person_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_personProduct"+ vproduct_person_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_personEtc"+ vproduct_person_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_personSum"+ vproduct_person_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' id='txt_personBigo"+ vproduct_person_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' id='txt_person_rev"+ vproduct_product_delete_table_RowCount +"' style='float:left; width:95%; display:none'></input>",
    		""
        ] ).draw();
		...
		var trInput = $($("#person_tbody tr")[vproduct_person_delete_table_RowCount-1]).find(":input");
		trInput.eq(0).val(vproduct_person_delete_table_RowCount);
		var vSerialNo =  "00000" + "1";
		var vLotNo = trInput.eq(6).val();
		
	    for(i=0;i<vproduct_person_delete_table_RowCount;i++){
		...
		$("#txt_LOTNo"+(vproduct_person_delete_table_RowCount-1)).on('change', function(){ 
	        vproduct_person_delete_table_info = vproduct_person_delete_table.page.info();
	        vproduct_person_delete_table_RowCount = vproduct_person_delete_table_info.recordsTotal; 
		...
		$("#txt_LOTCount"+(vproduct_person_delete_table_RowCount-1)).on('change', function(){ 
	        vproduct_person_delete_table_info = vproduct_person_delete_table.page.info();
	        vproduct_person_delete_table_RowCount = vproduct_person_delete_table_info.recordsTotal; 
    ...
    function fn_mius_person_body(){  	        
        vproduct_person_delete_table
        .row( vproduct_person_delete_table_RowCount-1 )
        .remove()
        .draw();
    ...
    function fn_plus_product_body(){
    	vproduct_product_delete_table.row.add( [
    		"	<input type='text' class='form-control' id='txt_detail_seq'  style='width:30px;' readonly></input>",
    		"	<input type='text' class='form-control' id='txt_productDivision"+ vproduct_product_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' id='txt_productMeasure"+ vproduct_product_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_productCapacity"+ vproduct_product_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' id='txt_productBigo"+ vproduct_product_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' id='txt_product_rev"+ vproduct_product_delete_table_RowCount +"' style='float:left; width:95%; display:none;'></input>",
    		""
        ] ).draw();
		...
		var trInput = $($("#product_tbody tr")[vproduct_product_delete_table_RowCount-1]).find(":input");
		trInput.eq(0).val(vproduct_product_delete_table_RowCount);
		var vSerialNo =  "00000" + "1";
		var vLotNo = trInput.eq(6).val();
		
	    for(i=0;i<vproduct_product_delete_table_RowCount;i++){
	    	$('input[id=dateDelevery]').eq(i).datepicker({
	        	format: 'yyyy-mm-dd',
	        	autoclose: true,
	        	language: 'ko'
		...
		$("#txt_LOTNo"+(vproduct_product_delete_table_RowCount-1)).on('change', function(){ 
	        vproduct_product_delete_table_info = vproduct_product_delete_table.page.info();
	        vproduct_product_delete_table_RowCount = vproduct_product_delete_table_info.recordsTotal; 
		...
		$("#txt_LOTCount"+(vproduct_product_delete_table_RowCount-1)).on('change', function(){ 
	        vproduct_product_delete_table_info = vproduct_product_delete_table.page.info();
	        vproduct_product_delete_table_RowCount = vproduct_product_delete_table_info.recordsTotal; 
    ...
    function fn_mius_product_body(){  	        
        vproduct_product_delete_table
        .row( vproduct_product_delete_table_RowCount-1 )
        .remove()
        .draw();
    ...
    function fn_plus_permission_body(){
    	vproduct_permission_delete_table.row.add( [
    		"	<input type='text' class='form-control' id='txt_detail_seq'  style='width:30px;' readonly></input>",
    		"	<input type='text' class='form-control' id='txt_permissionDivision"+ vproduct_permission_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' id='txt_permissionName"+ vproduct_permission_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' id='txt_permissionInstitute"+ vproduct_permission_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' id='txt_permissionDate"+ vproduct_permission_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' id='txt_permissionBigo"+ vproduct_permission_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' id='txt_permission_rev"+ vproduct_permission_delete_table_RowCount +"' style='float:left; width:95%; display:none;'></input>",
    		""
        ] ).draw();
		...
		var trInput = $($("#permission_tbody tr")[vproduct_permission_delete_table_RowCount-1]).find(":input");
		trInput.eq(0).val(vproduct_permission_delete_table_RowCount);
		var vSerialNo =  "00000" + "1";
		var vLotNo = trInput.eq(6).val();
		
	    for(i=0;i<vproduct_permission_delete_table_RowCount;i++){
	    	$('input[id=dateDelevery]').eq(i).datepicker({
	        	format: 'yyyy-mm-dd',
	        	autoclose: true,
	        	language: 'ko'
		...
		$("#txt_LOTNo"+(vproduct_permission_delete_table_RowCount-1)).on('change', function(){ 
	        vproduct_permission_delete_table_info = vproduct_permission_delete_table.page.info();
	        vproduct_permission_delete_table_RowCount = vproduct_permission_delete_table_info.recordsTotal; 
		...
		$("#txt_LOTCount"+(vproduct_permission_delete_table_RowCount-1)).on('change', function(){ 
	        vproduct_permission_delete_table_info = vproduct_permission_delete_table.page.info();
	        vproduct_permission_delete_table_RowCount = vproduct_permission_delete_table_info.recordsTotal; 
    ...
    function fn_mius_permission_body(){  	        
        vproduct_permission_delete_table
        .row( vproduct_permission_delete_table_RowCount-1 )
        .remove()
        .draw();
    ...
    function fn_plus_equipment_body(){
    	vproduct_equipment_delete_table.row.add( [
    		"	<input type='text' class='form-control' id='txt_detail_seq'  style='width:30px;' readonly></input>",
    		"	<input type='text' class='form-control' id='txt_equipmentName"+ vproduct_equipment_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' id='txt_equipmentStandard"+ vproduct_equipment_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' id='txt_equipmentManufacturer"+ vproduct_equipment_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_equipmentHave"+ vproduct_equipment_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' id='txt_equipmentBigo"+ vproduct_equipment_delete_table_RowCount +"' style='float:left; width:95%;' disabled></input>",
    		"	<input type='text' class='form-control' id='txt_equipment_rev"+ vproduct_equipment_delete_table_RowCount +"' style='float:left; width:95%; display:none;'></input>",
    		""
        ] ).draw();
		...
		var trInput = $($("#equipment_tbody tr")[vproduct_equipment_delete_table_RowCount-1]).find(":input");
		trInput.eq(0).val(vproduct_equipment_delete_table_RowCount);
		var vSerialNo =  "00000" + "1";
		var vLotNo = trInput.eq(6).val();
		
	    for(i=0;i<vproduct_equipment_delete_table_RowCount;i++){
	    	$('input[id=dateDelevery]').eq(i).datepicker({
	        	format: 'yyyy-mm-dd',
	        	autoclose: true,
	        	language: 'ko'
		...
		$("#txt_LOTNo"+(vproduct_equipment_delete_table_RowCount-1)).on('change', function(){ 
	        vproduct_equipment_delete_table_info = vproduct_equipment_delete_table.page.info();
	        vproduct_equipment_delete_table_RowCount = vproduct_equipment_delete_table_info.recordsTotal; 
		...
		$("#txt_LOTCount"+(vproduct_equipment_delete_table_RowCount-1)).on('change', function(){ 
	        vproduct_equipment_delete_table_info = vproduct_equipment_delete_table.page.info();
	        vproduct_equipment_delete_table_RowCount = vproduct_equipment_delete_table_info.recordsTotal; 
    ...
    function fn_mius_equipment_body(){  	        
        vproduct_equipment_delete_table
        .row( vproduct_equipment_delete_table_RowCount-1 )
        .remove()
        .draw();
		...
		<td style="width: 70%;">
   			<table class="table table-bordered" style="width: 100%; margin: 0 auto; align:left">
		        ...
		        <tr class="subcontractor" style="background-color: #fff;">
		            ...
		            <td colspan="3"> 
		            	<input type="text" id="txt_subcontractor_name" class="form-control" style="width: 365px; border: solid 1px #cccccc; float: left;" disabled/>
		        ...
		        <tr class="subcontractor" style="background-color: #fff" >
		            ...
		            <td colspan="3"><input type="text" class="form-control" id="txt_subcontractor_headoffice_address" style="width: 400px; float:left;" disabled/>
           			&nbsp;&nbsp;<input type="button" class="btn btn-info" onclick="pop_add_headoffice_search(this);" value="검색" disabled></input></td>		        

		            <td style=" font-weight: 900; font-size:14px; text-align:left" >본사전화번호</td>
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_headoffice_phone" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>		       
		        </tr>
		        <tr class="subcontractor" style="background-color: #fff" >
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >대표자명</td> 
		           	<td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_subcontractor_ceo" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>
		        ...
		        <tr class="subcontractor" style="background-color: #fff" >
		            ...
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_uptae" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>		  
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >종목</td> 
		           	<td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_jongmok" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>		                 
		        </tr>

		        <tr class="subcontractor" style="background-color: #fff" >
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >팩스번호</td>
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_faxno" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>		
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >홈페이지</td> 
		           	<td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_homepage" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>		                   
		        </tr>
		        
		        <tr class="subcontractor" style="background-color: #fff" >
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >우편번호</td>
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_zipno" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >당사담당자</td> 
		           	<td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_dangsa_damdangja" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>		       
		        </tr>
	
		        <tr class="subcontractor" style="background-color: #fff" >
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >고객사담당자</td>
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_cust_damdangja" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>		      
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >담당자전화번호</td> 
		           	<td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_damdangja_dno" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td> 
		        </tr>	        

  		        <tr class="subcontractor" style="background-color: #fff" >
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >담당자휴대전화</td>
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_damdangja_hpno" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>		       
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >담당자이메일</td> 
		           	<td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_damdangja_email" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>
		        </tr>

  		        <tr class="subcontractor" style="background-color: #fff" >
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >방문주기</td>
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_visit_jugi_day" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>		    
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >매입매출구분</td> 
		           	<td>
						<input type="radio" id="txt_io_gb" name="io_gb" value="I" checked disabled/>입고
						<label style="width:5%"></label>
						<input type="radio" id="txt_io_gb" name="io_gb" value="O" disabled/>  출고
					</td>             
		        </tr>
		        
  		        <tr class="subcontractor" style="background-color: #fff" >
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >(구)회사명</td>
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_old_cust_cd" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>		
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >거래개시일</td>
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_start_date" class="form-control" style="width: 400px; border: solid 1px #cccccc;" readonly/></td>	       
		        </tr>		        
  		        <tr class="subcontractor" style="background-color: #fff" >
		            ...
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_modify_reason" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>			       
		        </tr>
		       ...
		       <tr class="subcontractor_sub" style="background-color: #fff" >
		        ...
		        <tr class="subcontractor_sub" style="background-color: #fff" >
		            ...
		            <td colspan="3"><input type="text" class="form-control" id="txt_subcontractor_factory_address" style="width: 400px; float:left;" disabled/>
           			&nbsp;&nbsp;<input type="button" class="btn btn-info" onclick="pop_add_factory_search(this);" value="검색" disabled></input></td>
		            <td style=" font-weight: 900; font-size:14px; text-align:left">공장전화번호</td>       
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_subcontractor_factory_phone" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td> 			
		        </tr>		        	
				
		        <tr class="subcontractor_sub" style="background-color: #fff; ">
		            <td style=" font-weight: 900; font-size:14px; text-align:left"  >공장규모</td>
		            <td  colspan="3"> <input type="text" numberOnly data-date-format="yyyy-mm-dd" id="txt_factory_scale"  class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>
	 		        <td style=" font-weight: 900; font-size:14px; text-align:left">설립일자</td>       
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_establish_date" class="form-control" style="width: 400px; border: solid 1px #cccccc;" disabled/></td>
		        </tr>	            
		        
		        <tr class="subcontractor_sub" style="background-color: #fff" >
	            	<td style=" font-weight: 900; font-size:14px; text-align:left">평가방법</td>
	            	<td>
						<input type="radio" id="txt_appraisal_means" name="chk_info" value="실사평가" disabled/>실사평가
						<label style="width:5%"></label>
						<input type="radio" id="txt_appraisal_means" name="chk_info" value="견본평가" disabled/>  견본평가
						<label style="width:5%"></label>
						<input type="radio" id="txt_appraisal_means" name="chk_info" value="이력 및 서류평가" disabled/>  이력 및 서류평가
					</td>
		        </tr>		 
						...
						<thead>
					        <tr class="" style="vertical-align: middle">
					            ...
					            <th style="width: 8%; font-weight: 900; font-size:14px; text-align:center; vertical-align: middle">
				                	<button alt="한줄 추가" id="btn_plus_person"  class="btn btn-info btn-sm" disabled >+</button>
				                	<button alt="한줄 삭제" id="btn_mius_person"  class="btn btn-info btn-sm" disabled >-</button></th>
				            </tr>    	
							...
							<thead>
						        <tr class="" style="vertical-align: middle">
						            ...
						            <th style="width: 13%; font-weight: 900; font-size:14px; text-align:center; vertical-align: middle">
					                	<button alt="한줄 추가" id="btn_plus_product"  class="btn btn-info btn-sm" disabled >+</button>
					                	<button alt="한줄 삭제" id="btn_mius_product"  class="btn btn-info btn-sm" disabled >-</button></th>
					            </tr>    	
							</thead>
					...
					<td id="permission_data" colspan="8">				
						...
						<thead>
					        <tr class="" style="vertical-align: middle">
					            ...
					            <th style="width: 0%; font-weight: 900; font-size:14px; text-align:center; vertical-align: middle; display:none;">rev</th>
					            <th style="width: 13%; font-weight: 900; font-size:14px; text-align:center; vertical-align: middle">
				                	<button alt="한줄 추가" id="btn_plus_permission"  class="btn btn-info btn-sm" disabled >+</button>
				                	<button alt="한줄 삭제" id="btn_mius_permission"  class="btn btn-info btn-sm" disabled >-</button></th>
				            </tr>    		
						</thead>
					...
					<td id="equipment_data" colspan="8">	
						...
						<thead>
					        <tr class="" style="vertical-align: middle">
					            ...
					            <th style="width: 0%; font-weight: 900; font-size:14px; text-align:center; vertical-align: middle; display:none;">rev</th>					          
					            <th style="width: 8%; font-weight: 900; font-size:14px; text-align:center; vertical-align: middle">
				                	<button alt="한줄 추가" id="btn_plus_equipment"  class="btn btn-info btn-sm" disabled >+</button>
				                	<button alt="한줄 삭제" id="btn_mius_equipment"  class="btn btn-info btn-sm" disabled >-</button></th>
				            </tr>    	
