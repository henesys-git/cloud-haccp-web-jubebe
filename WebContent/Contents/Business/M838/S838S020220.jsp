...
<%
    ...
    TableModel = new DoyosaeTableModel("M838S020200E124", jArray);
    ...
    makeGridData.htmlTable_ID	= "tableS838S020220";
    ...
    $(document).ready(function () {
    	$('#<%=makeGridData.htmlTable_ID%>').DataTable({
    	    ...
    	    'createdRow': function(row) {	
	  		...
	  		'columnDefs': [{
	       		'targets': [0,1,2,3,4,6,8,9,10,11,12,13,16,17,18,19,20,21,22,23,24],
...
<table class='table table-bordered nowrap table-hover' id="<%=makeGridData.htmlTable_ID%>" style="width: 100%">
		...
		<tr>
		     ...
		     <th style='width:0px; display: none;'>HACCP승인</th>
