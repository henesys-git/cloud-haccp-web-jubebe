...
<%
	...
	Vector sulbiGroupVector = CommonData.getSulbiJobDataAll(member_key);
...
//  웹소켓 통신을 위해서 필요한 변수들 ---끝	
    var detail_seq=1;
   	var vproduct_person_input_table;
    var vproduct_person_input_table_Row_index = -1;
	var vproduct_person_input_table_info;
    var vproduct_person_input_table_RowCount=0;
   	var vproduct_product_input_table;
    var vproduct_product_input_table_Row_index = -1;
	var vproduct_product_input_table_info;
    var vproduct_product_input_table_RowCount=0;
   	var vproduct_permission_input_table;
    var vproduct_permission_input_table_Row_index = -1;
	var vproduct_permission_input_table_info;
    var vproduct_permission_input_table_RowCount=0;
   	var vproduct_equipment_input_table;
    var vproduct_equipment_input_table_Row_index = -1;
	var vproduct_equipment_input_table_info;
    var vproduct_equipment_input_table_RowCount=0;
        
    
    $(document).ready(function () {
    	detail_seq=1;
		// 인원현황 테이블
	    vproduct_person_input_table = $('#person_table').DataTable({
	    	scrollX: true,
		    scrollY: 250,
// 		    scrollCollapse: true,
		    paging: false,
    	...
    	// 생산능력 테이블
	    vproduct_product_input_table = $('#product_table').DataTable({
	    	scrollX: true,
		    scrollY: 250,
// 		    scrollCollapse: true,
		    paging: false,
	    ...
	    // 허가관계 테이블
	    vproduct_permission_input_table = $('#permission_table').DataTable({
	    	scrollX: true,
		    scrollY: 250,
// 		    scrollCollapse: true,
		    paging: false,
	    ...
	    // 설비현황 테이블
	    vproduct_equipment_input_table = $('#equipment_table').DataTable({
	    	scrollX: true,
		    scrollY: 250,
// 		    scrollCollapse: true,
		    paging: false,
        ...
        for(var i=0; i<vproduct_permission_input_table_RowCount; i++){	            
	...
	function SetRecvData(){
		DataPars(M838S060200E101, GV_RECV_DATA);  	
 		if(M838S060200E101.retnValue > 0)
 			alert('등록 되었습니다.');
	...
	function SaveOderInfo() {      
        ...
        for(var i=0; i<vproduct_person_input_table_RowCount;i++){
...
<%--     	jsonPerson.member_key			= '<%=member_key%>'; --%>
        ...
        for(var i=0; i<vproduct_product_input_table_RowCount;i++){
...
<%--     	jsonPermission.member_key			= '<%=member_key%>'; --%>
    		...
    		jsonPermission.permission_seq		= trInput.eq(6).val();
    		jsonPermission.permission_rev		= i;
        ...
        for(var i=0; i<vproduct_equipment_input_table_RowCount;i++){
...
//    	console.log("??? : " + user_id +" ~ "+ revision_no + " ~ " + user_nm);
    ...
    function fn_plus_person_body(){
    	vproduct_person_input_table.row.add( [
    		"	<input type='text' class='form-control' id='txt_detail_seq'  style='width:30px;' readonly></input>",
    		"	<input type='text' class='form-control' id='txt_personDivision"+ vproduct_person_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_personPeople"+ vproduct_person_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_personDesk"+ vproduct_person_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_personTechnicial"+ vproduct_person_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_personProduct"+ vproduct_person_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_personEtc"+ vproduct_person_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_personSum"+ vproduct_person_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' id='txt_personBigo"+ vproduct_person_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' id='txt_person_rev"+ vproduct_product_input_table_RowCount +"' style='float:left; width:95%; display:none' value='0'></input>",
    		""
        ] ).draw();
        ...
        vproduct_person_input_table_info = vproduct_person_input_table.page.info();
        vproduct_person_input_table_RowCount = vproduct_person_input_table_info.recordsTotal; 	
        
		var trInput = $($("#person_tbody tr")[vproduct_person_input_table_RowCount-1]).find(":input");
		trInput.eq(0).val(vproduct_person_input_table_RowCount);
		var vSerialNo =  "00000" + "1";
		var vLotNo = trInput.eq(6).val();
		
	    for(i=0;i<vproduct_person_input_table_RowCount;i++){
		...
		$("#txt_LOTNo"+(vproduct_person_input_table_RowCount-1)).on('change', function(){ 
	        vproduct_person_input_table_info = vproduct_person_input_table.page.info();
	        vproduct_person_input_table_RowCount = vproduct_person_input_table_info.recordsTotal; 
		...
		$("#txt_LOTCount"+(vproduct_person_input_table_RowCount-1)).on('change', function(){ 
	        vproduct_person_input_table_info = vproduct_person_input_table.page.info();
	        vproduct_person_input_table_RowCount = vproduct_person_input_table_info.recordsTotal; 
    ...
    function fn_mius_person_body(){  	        
        vproduct_person_input_table
        .row( vproduct_person_input_table_RowCount-1 )
        .remove()
        .draw();
    ...
    function fn_plus_product_body(){
    	vproduct_product_input_table.row.add( [
    		"	<input type='text' class='form-control' id='txt_detail_seq'  style='width:30px;' readonly></input>",
    		"	<input type='text' class='form-control' id='txt_productDivision"+ vproduct_product_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' id='txt_productMeasure"+ vproduct_product_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_productCapacity"+ vproduct_product_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' id='txt_productBigo"+ vproduct_product_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' id='txt_product_rev"+ vproduct_product_input_table_RowCount +"' style='float:left; width:95%; display:none;' value='0'></input>",
    		""
        ] ).draw();
        ...
        vproduct_product_input_table_info = vproduct_product_input_table.page.info();
        vproduct_product_input_table_RowCount = vproduct_product_input_table_info.recordsTotal; 	
        
		var trInput = $($("#product_tbody tr")[vproduct_product_input_table_RowCount-1]).find(":input");
		trInput.eq(0).val(vproduct_product_input_table_RowCount);
		var vSerialNo =  "00000" + "1";
		var vLotNo = trInput.eq(6).val();
		
	    for(i=0;i<vproduct_product_input_table_RowCount;i++){
	    	$('input[id=dateDelevery]').eq(i).datepicker({
	        	format: 'yyyy-mm-dd',
	        	autoclose: true,
	        	language: 'ko'
		...
		$("#txt_LOTNo"+(vproduct_product_input_table_RowCount-1)).on('change', function(){ 
	        vproduct_product_input_table_info = vproduct_product_input_table.page.info();
	        vproduct_product_input_table_RowCount = vproduct_product_input_table_info.recordsTotal; 
		...
		$("#txt_LOTCount"+(vproduct_product_input_table_RowCount-1)).on('change', function(){ 
	        vproduct_product_input_table_info = vproduct_product_input_table.page.info();
	        vproduct_product_input_table_RowCount = vproduct_product_input_table_info.recordsTotal; 
    ...
    function fn_mius_product_body(){  	        
        vproduct_product_input_table
        .row( vproduct_product_input_table_RowCount-1 )
        .remove()
        .draw();
    ...
    function fn_plus_permission_body(){
    	vproduct_permission_input_table.row.add( [
    		"	<input type='text' class='form-control' id='txt_detail_seq'  style='width:30px;' readonly></input>",
    		"	<input type='text' class='form-control' id='txt_permissionDivision"+ vproduct_permission_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' id='txt_permissionName"+ vproduct_permission_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' id='txt_permissionInstitute"+ vproduct_permission_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' id='txt_permissionDate"+ vproduct_permission_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' id='txt_permissionBigo"+ vproduct_permission_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' id='txt_permission_rev"+ vproduct_permission_input_table_RowCount +"' style='float:left; width:95%; display:none;' value='0'></input>",
        ...
        vproduct_permission_input_table_info = vproduct_permission_input_table.page.info();
        vproduct_permission_input_table_RowCount = vproduct_permission_input_table_info.recordsTotal; 	
        
		var trInput = $($("#permission_tbody tr")[vproduct_permission_input_table_RowCount-1]).find(":input");
		trInput.eq(0).val(vproduct_permission_input_table_RowCount);
		var vSerialNo =  "00000" + "1";
		var vLotNo = trInput.eq(6).val();
		
	    for(i=0;i<vproduct_permission_input_table_RowCount;i++){
	    	$('input[id=dateDelevery]').eq(i).datepicker({
	        	format: 'yyyy-mm-dd',
	        	autoclose: true,
	        	language: 'ko'
		...
		$("#txt_LOTNo"+(vproduct_permission_input_table_RowCount-1)).on('change', function(){ 
	        vproduct_permission_input_table_info = vproduct_permission_input_table.page.info();
	        vproduct_permission_input_table_RowCount = vproduct_permission_input_table_info.recordsTotal; 
		...
		$("#txt_LOTCount"+(vproduct_permission_input_table_RowCount-1)).on('change', function(){ 
	        vproduct_permission_input_table_info = vproduct_permission_input_table.page.info();
	        vproduct_permission_input_table_RowCount = vproduct_permission_input_table_info.recordsTotal; 
    ...
    function fn_mius_permission_body(){  	        
        vproduct_permission_input_table
        .row( vproduct_permission_input_table_RowCount-1 )
        .remove()
        .draw();
    ...
    function fn_plus_equipment_body(){
    	vproduct_equipment_input_table.row.add( [
    		"	<input type='text' class='form-control' id='txt_detail_seq'  style='width:30px;' readonly></input>",
    		"	<input type='text' class='form-control' id='txt_equipmentName"+ vproduct_equipment_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' id='txt_equipmentStandard"+ vproduct_equipment_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' id='txt_equipmentManufacturer"+ vproduct_equipment_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' numberOnly id='txt_equipmentHave"+ vproduct_equipment_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' id='txt_equipmentBigo"+ vproduct_equipment_input_table_RowCount +"' style='float:left; width:95%;'></input>",
    		"	<input type='text' class='form-control' id='txt_equipment_rev"+ vproduct_equipment_input_table_RowCount +"' style='float:left; width:95%; display:none;' value='0'></input>",
    		""
        ] ).draw();
        ...
        vproduct_equipment_input_table_info = vproduct_equipment_input_table.page.info();
        vproduct_equipment_input_table_RowCount = vproduct_equipment_input_table_info.recordsTotal; 	
        
		var trInput = $($("#equipment_tbody tr")[vproduct_equipment_input_table_RowCount-1]).find(":input");
		trInput.eq(0).val(vproduct_equipment_input_table_RowCount);
		var vSerialNo =  "00000" + "1";
		var vLotNo = trInput.eq(6).val();
		
	    for(i=0;i<vproduct_equipment_input_table_RowCount;i++){
	    	$('input[id=dateDelevery]').eq(i).datepicker({
	        	format: 'yyyy-mm-dd',
	        	autoclose: true,
	        	language: 'ko'
		...
		$("#txt_LOTNo"+(vproduct_equipment_input_table_RowCount-1)).on('change', function(){ 
	        vproduct_equipment_input_table_info = vproduct_equipment_input_table.page.info();
	        vproduct_equipment_input_table_RowCount = vproduct_equipment_input_table_info.recordsTotal; 
		...
		$("#txt_LOTCount"+(vproduct_equipment_input_table_RowCount-1)).on('change', function(){ 
	        vproduct_equipment_input_table_info = vproduct_equipment_input_table.page.info();
	        vproduct_equipment_input_table_RowCount = vproduct_equipment_input_table_info.recordsTotal; 
    ...
    function fn_mius_equipment_body(){  	        
        vproduct_equipment_input_table
        .row( vproduct_equipment_input_table_RowCount-1 )
        .remove()
        .draw();
		...
		<td style="width: 70%;">
   			<table class="table table-bordered" style="width: 100%; margin: 0 auto; align:left">
		        ...
		        <tr class="subcontractor" style="background-color: #fff" >
		            ...
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >사업자번호</td> 
		           	<td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_bizno" class="form-control" style="width: 400px; border: solid 1px #cccccc;" /></td>		           	 			
		        </tr>
		        ...
		        <tr class="subcontractor" style="background-color: #fff" >
  		        ...
  		        <tr class="subcontractor" style="background-color: #fff" >
		            ...
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_refno" class="form-control" style="width: 400px; border: solid 1px #cccccc;" /></td>		       
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >수정사유</td>
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_modify_reason" class="form-control" style="width: 400px; border: solid 1px #cccccc;" readonly/></td>		       
		        </tr>
		       ...
		       <tr class="subcontractor_sub" style="background-color: #fff" >
		        ...
		        <tr class="subcontractor_sub" style="background-color: #fff" >
	            	...
	            	<td>
						<input type="radio" id="txt_appraisal_means" name="chk_info" value="실사평가" checked/>실사평가
						<label style="width:5%"></label>
