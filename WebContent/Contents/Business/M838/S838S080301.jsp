...
<script type="text/javascript">
	...
	function SaveOderInfo() {
		...
		if(flag){
			...
			if(chekrtn) {
				SendTojsp(JSONparam, "M838S080300E101");
			}
		}
	}
	    ...
	    $.ajax({
			...
			success: function (html) {	
				if(html > -1) {
					...
					heneSwal.error('기록일지 등록 실패했습니다, 다시 시도해주세요');	         		
	         	}
	         }
	     });
	}
...
<form id = "edu_frm" onsubmit = "return false;">
	<table class="table" id="edu_table" style = "margin-bottom: 0; ">
		<tr>
		    ...
		    <td>
		    	시작
				<input type="time" id="edu_start_time" name = "edu_start_time" class="form-control" style = "margin-right : 4%;" required />
				종료
				<input type="time" id="edu_end_time" name = "edu_end_time" class="form-control" required />
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
		    ...
		    <td colspan = 3>
				<textarea id="edu_detail" name="edu_detail" class="form-control" style = "height: 100px;"> </textarea>
			</td>
		</tr>
		<tr>
			<td>
...
<table class="table" id = "fileUpload">
	<tr>
	    ...
	    <td>
			<input type="hidden" class="form-control" id="txt_pid" name="pid"  value="M838S080300E111">
			...
			<input type="hidden" class="form-control" id="txt_jspPage" name="jspPage"  value="M838S080301.jsp"> 
