...
<%
    ...
    DoyosaeTableModel TableModel = new DoyosaeTableModel("M838S100100E104", jArray);
 	MakeGridData tData = new MakeGridData(TableModel);
    tData.htmlTable_ID = "TableS838S100100";
