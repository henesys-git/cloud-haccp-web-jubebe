...
*/
	...
	DoyosaeTableModel table = new DoyosaeTableModel("M838S020900E154", jArray);
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$("input:radio[name=result_1]:input[value="+dataArr[0][4]+"]").attr("checked",true);
		...
		for(var i=1; i<=21; i++){
			...
			var html = "<div style = 'margin-bottom :"+mrbt+";'>"+
	 		...
	 		$('input:radio[name=result_'+(i+1)+']:input[value="'+dataArr[i][4]+'"]').attr("checked",true);
	...
	function SaveOderInfo() {
		...
		if(chekrtn) {
			SendTojsp(JSONparam, "M838S020900E112");
		}
	}
 ...
 <form id = "prodFac_frm" onsubmit="return false;">
