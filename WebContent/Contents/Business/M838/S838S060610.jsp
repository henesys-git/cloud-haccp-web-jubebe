...
<%
	...
	String GV_VHCL_NO="",GV_VHCL_NO_REV="", GV_CHECK_DATE="", GV_CHECK_DURATION="", GV_CHECK_GUBUN="";
    ...
    TableModel = new DoyosaeTableModel("M838S060600E114", jArray);
...
<!-- 		     <th style='width:0px; display: none;'>구분</th> -->
		     ...
		     <th style='width:0px; display: none;'>구분 중분류</th>
		     <th style='width:0px; display: none;'>구분 소분류 코드</th>
		     <th style='width:0px; display: none;'>구분 소분류</th>
