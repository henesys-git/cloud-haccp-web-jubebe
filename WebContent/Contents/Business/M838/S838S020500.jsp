...
<%
    ...
    DoyosaeTableModel TableModel = new DoyosaeTableModel("M838S020500E104", jArray);	
 	MakeGridData tData = new MakeGridData(TableModel);
 	tData.htmlTable_ID = "TableS838S020500";
%>
<script>
