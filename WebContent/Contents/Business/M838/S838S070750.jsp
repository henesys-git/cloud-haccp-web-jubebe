...
<%
    ...
    DoyosaeTableModel TableModel = new DoyosaeTableModel("M838S070750E104", jArray);
 	MakeGridData tData = new MakeGridData(TableModel);
 	tData.htmlTable_ID = "TableS838S070750";
%>
<style>
.open_file i {
	color: yellowgreen;
...
<script>
    ...
    function clickMainMenu(obj){
		...
		judge_date = td.eq(3).text().trim();
		person_check_id = td.eq(4).text().trim();
		person_inspect_id = td.eq(5).text().trim();
