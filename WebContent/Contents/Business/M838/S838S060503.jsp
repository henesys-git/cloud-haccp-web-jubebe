...
<%
	...
	TableModel = new DoyosaeTableModel("M838S060500E144", jArray);
...
// 	    var today = new Date("2019-06-02"); // 특정날짜
	    ...
	    for(var i=0; i<TableInoutCheck_RowCount; i++){
			...
			dataJson.check_person		= $("#txt_writor_main").val();
...
<body>
	<table class="table" style="width: 100%; margin: 0 auto; align:left">
		...
		<tr>
            ...
            <td style="width: auto;  font-weight: 900; font-size:14px; vertical-align: middle ;text-align:left">
				<input type="text" class="form-control" id="txt_driver"
					value='<%=TableModel.getValueAt(0, 21).toString().trim()%>' readonly />
           	</td>
		</tr>
		<tr>
            ...
            <td style="width: auto;  font-weight: 900; font-size:14px; vertical-align: middle ;text-align:left" colspan="3">
				<input type="text" class="form-control" data-date-format="yyyy-mm-dd" id="txt_strange_date"
					value='<%=TableModel.getValueAt(0, 22).toString().trim()%>' readonly/>
           	</td>
		</tr>
		<tr>
            ...
            <td style="width: auto;  font-weight: 900; font-size:14px; vertical-align: middle ;text-align:left" colspan="3">
				<input type="text" class="form-control" id="txt_strange_note"
					value='<%=TableModel.getValueAt(0, 23).toString().trim()%>' readonly/>
           	</td>
		</tr>
		<tr>
            ...
            <td style="width: auto;  font-weight: 900; font-size:14px; vertical-align: middle ;text-align:left" colspan="3">
				<input type="text" class="form-control" id="txt_strange_result"
					value='<%=TableModel.getValueAt(0, 24).toString().trim()%>' readonly/>
           	</td>
		</tr>
		<tr>
           	<td style="width: 150px; font-weight: 900; font-size:14px; vertical-align: middle ; text-align:left">조치완료일시</td>
            <td style="width: auto;  font-weight: 900; font-size:14px; vertical-align: middle ;text-align:left" colspan="3">
				<input type="text" class="form-control" data-date-format="yyyy-mm-dd" id="txt_strange_result_date"
					value='<%=TableModel.getValueAt(0, 25).toString().trim()%>' readonly/>
           	</td>
		</tr>
		<tr>
            ...
            <td style="width: auto;  font-weight: 900; font-size:14px; vertical-align: middle ;text-align:left">
				<input type="text" class="form-control" id="txt_strange_result_person"
					value='<%=TableModel.getValueAt(0, 26).toString().trim()%>' readonly/>
           	</td>
            ...
            <td style="width: auto;  font-weight: 900; font-size:14px; vertical-align: middle ;text-align:left">
				<input type="text" class="form-control" id="txt_strange_result_check"
					value='<%=TableModel.getValueAt(0, 27).toString().trim()%>' readonly/>
           	</td>
		</tr>
		<tr>
            ...
            <td style="width: auto;  font-weight: 900; font-size:14px; vertical-align: middle ;text-align:left">
				<input type="text" class="form-control" id="txt_check_person"
					value='<%=TableModel.getValueAt(0, 28).toString().trim()%>' readonly/>
           	</td>
		</tr>
	</table>
