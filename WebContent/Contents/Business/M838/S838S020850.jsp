...
<%
    ...
    DoyosaeTableModel TableModel = new DoyosaeTableModel("M838S020850E104", jArray);
 	MakeGridData tData = new MakeGridData(TableModel);
    tData.htmlTable_ID = "TableS838S020850";
%>
<script>
