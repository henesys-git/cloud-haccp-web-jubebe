...
<%
    ...
    DoyosaeTableModel TableModel = new DoyosaeTableModel("M838S020100E104", jArray);
 	MakeGridData tData = new MakeGridData(TableModel);
    tData.htmlTable_ID = "TableS838S020100";
%>
<script>
    ...
    function clickMainMenu(obj){
		...
		person_check = td.eq(6).text().trim();
		person_approve = td.eq(7).text().trim();
