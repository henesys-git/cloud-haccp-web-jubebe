...
*/	
	...
	String CHECK_GUBUN_TYENS = "IMPORT";
	...
	jArray.put( "IMPORT", CHECK_GUBUN_TYENS);
	...
	//구분, 점검항목
	DoyosaeTableModel TableModelE134 = new DoyosaeTableModel("M838S070200E134", jArray);
	...
	System.out.println("TOTAL_GV_PAGE_COUNT : " + TOTAL_GV_PAGE_COUNT);
%>
...
<script type="text/javascript">	
	...
	var DataGrid1 = {
		...
		drawGrid: function(ctx, sx, sy, ex, ey) { // 표1 양식 그리기
			...
			for(i=0; i<this.col_data.length; i++){
				...
				ctx_wrapText(ctx, 10+col_head_x_divide*2*0+col_head_x_divide*6.22, sy+DataGrid1_RowHeight1st/2+50*(i+1), this.col_data[i][4] + ' 일', 'black', vTextStyle, 'center','middle', 100, 17); // 유통기한 
	...
	function fn_Pre_Page() {
		var modalContentUrl  = "<%=Config.this_SERVER_path%>/Contents/Business/M838/S838S070200_canvas_tyens.jsp"
