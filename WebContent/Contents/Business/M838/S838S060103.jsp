...
<body>
	<table class="table" style="width: 100%; margin: 0 auto; align:left">
		...
		<tr>
            ...
            <td style="width: auto;  font-weight: 900; font-size:14px; vertical-align: middle ;text-align:left" colspan="2">
				<input type="text" class="form-control" id="txt_incong_note" value='<%=TableModel.getValueAt(0, 21).toString().trim()%>' readonly />
           	</td>
		</tr>
		<tr>
           	<td style="width: 150px; font-weight: 900; font-size:14px; vertical-align: middle ; text-align:left">개선 조치 사항</td>
            <td style="width: auto;  font-weight: 900; font-size:14px; vertical-align: middle ;text-align:left" colspan="2">
				<input type="text" class="form-control" id="txt_improve_note" value='<%=TableModel.getValueAt(0, 22).toString().trim()%>' readonly />
           	</td>
		</tr>
		<tr>
           	<td style="width: 150px; font-weight: 900; font-size:14px; vertical-align: middle ; text-align:left">개선조치확인란</td>
            <td style="width: auto;  font-weight: 900; font-size:14px; vertical-align: middle ;text-align:left" colspan="2">
				<input type="text" class="form-control" id="txt_improve_note_check" value='<%=TableModel.getValueAt(0, 23).toString().trim()%>' readonly />
           	</td>
		</tr>
		<tr>
           	<td style="width: 150px; font-weight: 900; font-size:14px; vertical-align: middle ; text-align:left">특기사항</td>
            <td style="width: auto;  font-weight: 900; font-size:14px; vertical-align: middle ;text-align:left" colspan="2">
				<input type="text" class="form-control" id="txt_uniqueness" value='<%=TableModel.getValueAt(0, 24).toString().trim()%>' readonly />
           	</td>
		</tr>
	</table>
