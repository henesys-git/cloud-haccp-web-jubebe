...
.mainPlus div:first-child input {
	display : block; 
	width :100%; 
	height:27px;
}
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		cvs.src = "images/checklist_insert/checklist31_insert.jpg"
	...
	function SaveOderInfo() {
		...
		if(chekrtn) {
			SendTojsp(JSONparam, "M838S020900E101");
		}
	}
 ...
 <form id = "prodFac_frm" onsubmit="return false;" style = "height : 900px;">
	...
	<div style = "display : inline-block;" class = "mainPlus">
		<div style = "width: 122px; float: left;">
			<input type = "time" id = "occur_time" />
			<input type = "text" placeholder = "발생장소" id = "occur_place"/>
		</div> 
		<div style = "width : 232px; height : 90%;">
			<textarea class="form-control" id = "unsuit_detail" style = "height: 55px;"></textarea>
		</div>
		<div style = "width : 217px;  float: right;">
			<textarea class="form-control" id = "improve_action" style = "height: 55px;"></textarea>
		</div>
	</div>
</form>