...
<%
    ...
    DoyosaeTableModel TableModel = new DoyosaeTableModel("M838S015500E104", jArray);	
 	MakeGridData tData = new MakeGridData(TableModel);
    tData.htmlTable_ID = "TableS838S015500";
%>
<script>
    ...
    function clickMainMenu(obj){
		...
		improve_action2 = td.eq(7).text().trim();
		improve_action3 = td.eq(8).text().trim();
		improve_action4 = td.eq(9).text().trim();
		person_write_id = td.eq(10).text().trim();
		person_writer = td.eq(11).text().trim();
		person_check_id = td.eq(12).text().trim();
		person_checker = td.eq(13).text().trim();
		person_approve_id = td.eq(14).text().trim();
		person_approver = td.eq(15).text().trim();
