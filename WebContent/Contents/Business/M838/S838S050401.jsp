...
//  웹소켓 통신을 위해서 필요한 변수들 ---끝	
	...
	$(document).ready(function () {
		// 날짜만
		$("#txt_extnl_in_date").datepicker({
        	format: 'yyyy-mm-dd',
        	autoclose: true,
        	language: 'ko'
        });
		var today = new Date();
		$('#txt_extnl_in_date').datepicker('update', today);
		
// 		// 날짜&시간
// 		$("#txt_extnl_in_date").daterangepicker({
...
//      });
    	var today = new Date();
        $('#txt_extnl_in_date').data('daterangepicker').setStartDate(today);
...
// 	    var today = new Date("2019-06-02"); // 특정날짜
		...
		var write_time 	= ("0" + today.getHours()).slice(-2) 
		...
		dataJson.extnl_in_date = $("#txt_extnl_in_date").val() + ' ' + write_time;
...
<!-- <form id="mesfrm"> -->
   <table class="table table-hover" style="width: 100%; margin: 0 auto; align:left">
        ...
        <tr style="background-color: #fff; height: 40px">
            ...
            <td> </td>
            <td >
            	<input type="text" class="form-control" id="txt_extnl_in_object" style="width: 300px; float:left" />
           	</td>
        </tr>
        ...
        <tr style="background-color: #fff; height: 40px">
            <td>방문자 소속</td>
            <td> </td>
            <td ><input type="text" class="form-control" id="txt_extnl_in_conpany" style="width: 300px; float:left"  />
           	</td>
        </tr>
        ...
        <tr style="background-color: #fff; height: 40px">
            <td>방문자 직위</td>
            <td> </td>
            <td ><input type="text" class="form-control" id="txt_extnl_in_title" style="width: 300px; float:left" />
           	</td>
        </tr>
        ...
        <tr style="background-color: #fff; height: 40px">
            <td>방문자 성명</td>
            <td> </td>
            <td ><input type="text" class="form-control" id="txt_extnl_in_cust_name" style="width: 300px; float:left"  />
           	</td>
        </tr>
