...
<%
	...
	System.out.println("GV_SUBCONSTRACTOR_SEQ : "+ GV_SUBCONSTRACTOR_REV);
	JSONObject jArray = new JSONObject();
	jArray.put( "subcontractor_no", GV_SUBCONSTRACTOR_NO);
	jArray.put( "subcontractor_rev", GV_SUBCONSTRACTOR_REV);
	jArray.put( "member_key", member_key);
	
	TableModel = new DoyosaeTableModel("M838S060200E124", jArray);
    ...
    makeGridData.htmlTable_ID	= "tableS808S060220";
