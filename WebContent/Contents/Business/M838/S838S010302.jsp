...
//  웹소켓 통신을 위해서 필요한 변수들 ---끝	
	...
	function SetRecvData(){
		DataPars(M838S010300E102,GV_RECV_DATA);  		
	...
	function SaveOrderInfo() {        
		...
		if($("#txt_approval").val() == '') { 
   		...
   		var revplus = Number($("#txt_handover_rev ").val()) +1;
	   	...
	   	<tr>   
			<td style="width: 47%;">
				<table class="table " style="width: 100%; margin: 0 auto; align:left">
					...
					<tr>
						<!-- <td colspan="4"><textarea class="form-control" id="txt_accept_contents"  style="cols:10;rows:4; height:300px; resize:none;" ></textarea></td> -->
