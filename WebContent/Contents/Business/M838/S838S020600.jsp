...
<%
    ...
    DoyosaeTableModel TableModel = new DoyosaeTableModel("M838S020600E104", jArray);
 	MakeGridData tData = new MakeGridData(TableModel);
    tData.htmlTable_ID = "TableS838S020600";
