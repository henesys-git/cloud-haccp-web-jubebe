...
<%
    ...
    DoyosaeTableModel TableModel = new DoyosaeTableModel("M838S015100E104", jArray);
    MakeGridData tData = new MakeGridData(TableModel);
    tData.htmlTable_ID = "TableS838S015100";
%>
<script>
