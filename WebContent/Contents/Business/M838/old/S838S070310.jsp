...
<%
    ...
    TableModel = new DoyosaeTableModel("M838S070300E114", jArray);
    ...
    makeGridData.htmlTable_ID	= "tableS838S070310";
...
<table class='table table-bordered nowrap table-hover' id="<%=makeGridData.htmlTable_ID%>" style="width: 100%">
		<thead>
		<tr>
		     <th style='width:0px; display: none;'>계측기cd</th>
		     <th style='width:0px; display: none;'>계측기rev</th>
		     <th>계측기 번호</th>
		     <th>계측기명</th>
		     <th>사용장소</th>
		     <th>표준값</th>
