...
<%
    ...
    DoyosaeTableModel TableModel = new DoyosaeTableModel("M838S020800E104", jArray);
 	MakeGridData tData = new MakeGridData(TableModel);
    tData.htmlTable_ID = "TableS838S020800";
...
<script>
    ...
    function clickMainMenu(obj){
		...
		person_check_id 	= td.eq(5).text().trim();
