...
<%
    ...
    TableModel = new DoyosaeTableModel("M838S050600E104", jArray);
    ...
    makeGridData.htmlTable_ID	= "tableS838S050600";
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		var customOpts = {
				...
				columnDefs : [{
					'targets': [1,2,7,8,10,11,12,14,15],
...
<table class='table table-bordered nowrap table-hover' id="<%=makeGridData.htmlTable_ID%>" style="width: 100%">
		...
		<tr>
		     ...
		     <th>이상발생내용</th>
		     <th>이상조치내용</th>
		     <th style='width:0px; display: none;'>점검자아이디</th>
		     <th style='width:0px; display: none;'>점검자아이디rev</th>
		     <th>점검자</th>
		     ...
		     <th>작성자</th>
		     <th style='width:0px; display: none;'>승인자아이디</th>
		     <th style='width:0px; display: none;'>승인자아이디rev</th>
		     <th>승인자</th>
