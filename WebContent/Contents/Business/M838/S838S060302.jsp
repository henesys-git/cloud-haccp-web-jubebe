...
// 	alert(vproduct_update_table_Row_index);
	...
	function SetRecvData(){
		DataPars(M838S060300E102,GV_RECV_DATA);  		
...
//	         	 alert(bomdata);
    ...
    function fn_plus_body(){
    	vproduct_update_table.row.add( [
    		"	<input type='text' class='form-control' style='width: 100%;' id='txt_assessment_no"+vproduct_update_table_RowCount+"' value='" + vproduct_update_table_RowCount + "' readonly></input>",
    		"	<input type='text' class='form-control' style='width: 100%;' id='txt_assessment_rev"+vproduct_update_table_RowCount+"' style='display:none;' value='0'></input>",
    		"	<input type='text' class='form-control' style='width: 100%;' id='txt_assessment_division"+vproduct_update_table_RowCount+"' ></input>",
    		"	<input type='text' class='form-control' style='width: 100%;' id='txt_assessment_article"+vproduct_update_table_RowCount+"' ></input>",
    		"	<input type='text' class='form-control' style='width: 100%;' id='txt_assessment_standard"+vproduct_update_table_RowCount+"' ></input>",
    		"	<input type='text' class='form-control' style='width: 80%; float: left;' id='txt_assessment_result"+vproduct_update_table_RowCount+"' numberOnly></input>" + 
    		"	<input type='text' class='form-control' style='width: 20%;' id='txt_assessment_result_standard"+vproduct_update_table_RowCount+"' readonly></input>",
    		"	<input type='text' class='form-control' style='width: 100%;' id='txt_assessment_bigo"+vproduct_update_table_RowCount+"' '></input>",
    		""
        ] ).draw();
