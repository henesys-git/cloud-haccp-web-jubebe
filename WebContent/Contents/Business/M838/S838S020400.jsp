...
<%
    ...
    DoyosaeTableModel TableModel = new DoyosaeTableModel("M838S020400E104", jArray);
 	MakeGridData tData = new MakeGridData(TableModel);
 	tData.htmlTable_ID = "TableS838S020400";
%>
<script>
    ...
    function clickMainMenu(obj){
		...
		person_write_id = td.eq(3).text().trim();
		person_check_id = td.eq(4).text().trim();
		person_approve_id = td.eq(5).text().trim();
