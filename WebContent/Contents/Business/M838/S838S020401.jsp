    ...
    $(document).ready(function () {
		...
		for(var i=1; i<=6; i++){
			...
			for(var j=1; j<=12; j++){
				...
				var html = '<input type = "number" min = "0" name = "result_0'+i+'_'+j+'" class = "result" '+dis+' value = "0"/>';
		...
		for(var a=7; a<=10; a++){
			...
			var html = '<input type = "text" id = "facility'+a+'_position" class = "position"/><input type = "number" min = "0" name = "result_'+a+'_11" class = "result" value = "0"/><input type = "number" name = "result_'+a+'_12" class = "result" value = "0" disabled/><br>';
