...
<%
    ...
    DoyosaeTableModel TableModel = new DoyosaeTableModel("M838S020750E104", jArray);
 	MakeGridData tData = new MakeGridData(TableModel);
    tData.htmlTable_ID = "TableS838S020750";
%>
<script>
