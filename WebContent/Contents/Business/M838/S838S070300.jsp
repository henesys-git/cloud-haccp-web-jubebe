...
<%
    ...
    DoyosaeTableModel TableModel = new DoyosaeTableModel("M838S070300E104", jArray);
 	MakeGridData tData = new MakeGridData(TableModel);
 	tData.htmlTable_ID = "TableS838S070300";
%>
<script>
...
<table class='table table-bordered nowrap table-hover' id="<%=tData.htmlTable_ID%>" style="width:100%">
	<thead>
		<tr>
