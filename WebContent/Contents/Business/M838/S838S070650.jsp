...
<%
    ...
    DoyosaeTableModel TableModel = new DoyosaeTableModel("M838S070650E104", jArray);
 	MakeGridData tData = new MakeGridData(TableModel);
    tData.htmlTable_ID = "TableS838S070650";
...
<script>
    ...
    function clickMainMenu(obj){
		...
		inferior_nm = td.eq(4).text().trim();
		inferior_gubun = td.eq(5).text().trim();
		occur_date = td.eq(6).text().trim();
		occur_place = td.eq(7).text().trim();
		inferior_quantity = td.eq(8).text().trim();
		inferior_content = td.eq(9).text().trim();
