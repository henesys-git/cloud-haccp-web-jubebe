...
<%
    ...
    TableModel = new DoyosaeTableModel("M505S280100E214", strColumnHead, jArray);
		...
		<td style="width: 70%;">
   			<table class="table table-bordered" style="width: 100%; margin: 0 auto; align:left">
		        ...
		        <tr style="background-color: #fff; ">
		            ...
		            <td  colspan="3"> 
		            	<input type="text" numberOnly id="txt_Biyong"  class="form-control" style="width: 150px; border: solid 1px #cccccc; vertical-align: middle;"
