...
<%
	...
	String GV_PART_CD="", GV_PART_CD_REV="", GV_PART_NM="", GV_CHECKLIST_CD="", GV_CHECK_NOTE="", GV_CHECKLIST_SEQ="", GV_STANDARD_GUIDE="",
	...
	String param = GV_PART_CD + "|" + GV_CHECKLIST_CD + "|";
%>
...
// 체크항목 분할변수
	...
	function SetRecvData(){
		...
		DataPars(M909S124100E103, GV_RECV_DATA);
 		if(M909S124100E103.retnValue > 0)
 			alert('삭제 되었습니다.');
