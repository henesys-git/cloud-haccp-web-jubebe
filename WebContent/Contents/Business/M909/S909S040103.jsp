...
<%
	...
	String param = GV_ITEM_CD + "|" + GV_REVISION_NO + "|" + GV_ITEM_SEQ + "|";
...
//  웹소켓 통신을 위해서 필요한 변수들 ---끝	
	...
	function SetRecvData(){
		...
		DataPars(M909S040100E103, GV_RECV_DATA);
 		if(M909S040100E103.retnValue > 0)
 			alert('삭제 되었습니다.');
   		
   		parent.fn_MainInfo_List(3);
	...
	function SaveOderInfo() {
		...
		var delete_check = confirm("Rev(개정번호) 상관없이 해당 체크항목을 삭제합니다."+"\n"+"삭제하시겠습니까?");
		if(delete_check) {
   ...
   <table class="table table-hover" style="width: 100%; margin: 0 auto; align:left">
        ...
        <tr>
            <td colspan="3">
            	<textarea class="form-control" id="txt_Bigo"  style="cols:40;rows:4;resize: none;" readonly ><%=targetVector.get(5).toString()%>
            	</textarea>
            </td>
        </tr>
        ...
        <tr style="background-color: #fff; height: 40px">
            ...
            <td ><input type="text" class="form-control" id="txt_ItemSeq" style="width: 200px; float:left"
            	...
            	<input type="hidden" class="form-control" id="txt_RevisionNo" style="width: 200px; float:left" 
            		value="<%=targetVector.get(1).toString()%>"  />
           	</td>
        </tr>
        ...
        <tr style="background-color: #fff; height: 40px">
            ...
            <td >
            	<input type="text" data-date-format="yyyy-mm-dd" id="txt_StartDate" class="form-control"
                	style="width: 220px; border: solid 1px #cccccc;" disabled/>
