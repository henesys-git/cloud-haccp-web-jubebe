...
//  웹소켓 통신을 위해서 필요한 변수들 ---끝	
	...
	function SetRecvData(){
		...
		DataPars(M909S130100E103, GV_RECV_DATA);
 		if(M909S130100E103.retnValue > 0)
 			alert('삭제 되었습니다.');
...
//	         	 alert(bomdata);
	         ...
	         success: function (html) {
	        	 if(html>-1){
	        		heneSwal.success('문서코드 정보 삭제에 성공하였습니다.');
	        	   	parent.fn_MainInfo_List();
	                parent.$("#ReportNote").children().remove();
	                $('#modalReport').modal('hide');
	         	}
	        	 else{
	        		heneSwal.error('문서코드 정보 삭제에 실패하였습니다.'); 
	        	 }
	         },
   ...
   <table class="table table-hover" style="width: 100%; margin: 0 auto; align:left">
        ...
        <tr style="background-color: #fff; height: 40px">
            ...
            <td ><input type="text" class="form-control" id="txt_RevisionNo" style="width: 200px; float:left"	
            		value="<%=targetCustVector.get(1).toString().trim()%>" readonly />
           	</td>
        </tr>
        ...
        <tr style="height: 40px">
            ...
            <td></td>
            <td >
				<select class="form-control" id="select_Secret" style="width: 200px" readonly>
        ...
        <tr style="background-color: #fff; height: 40px">
            ...
            <td >
            	<input type="text" class="form-control" id="txt_HoldYear" style="width: 200px; float:left" 
            		value="<%=targetCustVector.get(4).toString() %>"readonly /> &nbsp;&nbsp;년
           	</td>
        </tr>
