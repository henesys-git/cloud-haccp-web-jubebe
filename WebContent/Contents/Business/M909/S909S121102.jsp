...
//  웹소켓 통신을 위해서 필요한 변수들 ---끝	
    var detail_seq=1;
	var vprocess_update_table;
    var vprocess_update_table_Row_index = -1;
	var vprocess_update_table_info;
    var vprocess_update_table_RowCount=0;
    var process_index= -1;
    var seolbi_index= -1;
    ...
    $(document).ready(function () {
    	detail_seq =1;
    	RowCount = '<%=RowCount%>'; 
	    vprocess_update_table = $('#process_update_table').DataTable({
	    	scrollX: true,
		    scrollY: 250,
// 		    scrollCollapse: true,
		    paging: false,
 ...
 */
	    ...
	    $("#btn_mius").click(function(){ 
     	...
     	vprocess_update_table_info = vprocess_update_table.page.info();
     	vprocess_update_table_RowCount = vprocess_update_table_info.recordsTotal;
	...
	function SaveOderInfo() {
        ...
        for(var i=0; i<vprocess_update_table_RowCount;i++){
			...
			if(trInput.eq(16).val()== ''){
   			...
   			dataJson.process_seq		= trInput.eq(0).val();
   			...
   			if(trInput.eq(22).val() == ''){ dataJson.start_date	= 'null'; } 
   			else { dataJson.start_date = trInput.eq(22).val(); }
   			if(trInput.eq(23).val() == ''){ dataJson.create_date	= 'null'; } 
   			else { dataJson.create_date = trInput.eq(23).val(); }
            dataJson.create_user_id		= "<%=loginID%>";
   			if(trInput.eq(25).val() == ''){ dataJson.modify_date	= 'null'; } 
   			else { dataJson.modify_date = trInput.eq(25).val(); }
   			dataJson.modify_user_id		= trInput.eq(26).val();
   			if(trInput.eq(27).val() == ''){ dataJson.duration_date	= 'null'; } 
   			else { dataJson.duration_date = trInput.eq(27).val(); }
...
//	    for(i=0; i<33; i++){ console.log(i+ ". "+ trInput.eq(i).attr("id") + " : " + trInput.eq(i).val()); }
    ...
    function fn_plus_body(){
    	vprocess_update_table.row.add( [
    		"	<input type='text' class='form-control' id='txt_detail_seq' style='width:30px;'></input>",
    		"	<input type='text' class='form-control' id='txt_member_key"+vprocess_update_table_RowCount+"'></input>",
    		"	<input type='text' class='form-control' id='txt_process_gubun"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_process_gubun_rev"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_proc_code_gb_big"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_proc_code_gb_mid"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_proc_cd"+vprocess_update_table_RowCount+"' style='float:left; width:70%;' value='' disabled></input>" +
    		"	<button type='button' onclick='processIns("+vprocess_update_table_RowCount+")' id='btn_SearchProd' class='btn btn-info' style='float:left;width:30%;'>검색</button> ",	// 6. 공정명
    		"	<input type='text' class='form-control' id='txt_proc_cd_rev"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_process_nm"+vprocess_update_table_RowCount+"' value='' readonly></input>",
    		"	<input type='text' class='form-control' id='txt_process_seq"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_dept_gubun"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_prod_cd"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_prod_cd_rev"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_std_proc_qnt"+vprocess_update_table_RowCount+"' value='' numberonly></input>",			// 14. 표준공수
    		"	<input type='text' class='form-control' id='txt_std_man_amt"+vprocess_update_table_RowCount+"' value='' numberonly></input>",			// 15. 필요인원수
    		"	<input type='text' class='form-control' id='txt_seolbi_cd"+vprocess_update_table_RowCount+"' style='float:left; width:70%;' value='' disabled></input>" + // 16. 설비코드
    		"	<button type='button' onclick='seolbiIns("+vprocess_update_table_RowCount+")' id='btn_SearchProd' class='btn btn-info' style='float:left;width:30%;'>검색</button> ",	
    		"	<input type='text' class='form-control' id='txt_seolbi_cd_rev"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_seolbi_line"+vprocess_update_table_RowCount+"' value=''></input>",			
    		"	<input type='text' class='form-control' id='txt_work_order_index"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_bigo"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_start_date' value='' readonly></input>",			
    		"	<input type='text' class='form-control' id='txt_create_date' value='' readonly></input>",			
    		"	<input type='text' class='form-control' id='txt_create_user_id"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_modify_date' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_modify_user_id"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_duration_date' value='9999-12-31'></input>",
    		"	<input type='text' class='form-control' id='txt_modify_reason"+vprocess_update_table_RowCount+"' value=''></input>",			
    		"	<input type='text' class='form-control' id='txt_check_data_type"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_delyn"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_product_process_yn"+vprocess_update_table_RowCount+"' value=''></input>",
    		"	<input type='text' class='form-control' id='txt_packing_process_yn"+vprocess_update_table_RowCount+"' value=''></input>",
    		""
		] ).draw();
    	...
    	vprocess_update_table_info = vprocess_update_table.page.info();
     	vprocess_update_table_RowCount = vprocess_update_table_info.recordsTotal;
	   	...
	   	var trInput = $($("#product_tbody tr")[vprocess_update_table_RowCount-1]).find(":input");
	   	trInput.eq(0).val(vprocess_update_table_RowCount);
	   	var vSerialNo =  "00000" + "1";
	   	var vLotNo = trInput.eq(6).val();
		   	   
	   	for(i=0;i<vprocess_update_table_RowCount;i++){
		   	var today = new Date();
		   		var fromday = new Date();
	...
	function fn_mius_body(){  	        
		vprocess_update_table
		.row( vprocess_update_table_RowCount-1 )
		.remove()
		.draw();
...
<body>
	...
	<table class="table " id="process_update_table" style="width: 100%; margin: 0 auto; align:left">
		<thead>
