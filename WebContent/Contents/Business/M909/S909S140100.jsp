...
/* =========================복사하여 수정 할 부분=================================================  */   
	...
	if(GV_REV_CHECK.equals("true")) GV_PID = "M909S140100E194";
	else if(GV_REV_CHECK.equals("false")) GV_PID = "M909S140100E195";
...
/* =========================복사하여 수정 할 부분====끝=====================================  */  
	...
	String RightButton[][]	= {{"off", "fn_Chart_View", rightbtnChartShow},{"off", "fn_Doc_Reg()", rightbtnDocSave},{"off", "file_real_name", rightbtnDocShow}};
 	...
 	/* =========================복사하여 수정 할 부분=================================================  */ 
    makeGridData.htmlTable_ID	= "tableS909S140100";
    /* =========================복사하여 수정 할 부분====끝=====================================  */  
...
<script type="text/javascript">
    ...
    function clickMainMenu(obj){
		...
		$(obj).attr("class", "hene-bg-color");
	 	...
	 	vCodeGroupGubun = td.eq(0).text().trim();
	 	vCodeValue		= td.eq(1).text().trim();
	 	vRevisionNo 	= td.eq(3).text().trim();
	 	fn_DetailInfo_List();
