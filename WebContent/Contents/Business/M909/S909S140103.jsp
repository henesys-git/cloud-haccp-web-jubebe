...
<%
	...
	DoyosaeTableModel TableModel = new DoyosaeTableModel("M909S140100E204",  jArray);
...
<script>
	...
	function SaveOderInfo() {
		...
		dataJson.member_key = "<%=member_key%>";
   		dataJson.code_cd = $("#select_CodeGroupGubun").val();
 		...
 		jArray.push(dataJson);
 	 	...
 	 	SendTojsp(JSON.stringify(dataJsonMulti), "M909S140100E103");
	}
			...
			success: function (html) {
	        	if(html > -1) {	        	   	
	                $('#modalReport').modal('hide');
	         		...
	         		heneSwal.success("공통코드 정보가 삭제 완료되었습니다");
	         	} else {
	         		heneSwal.error("공통코드 정보 삭제에 실패했습니다, 다시 시도해주세요");
	         	}
	         }
		});	
	}
        ...
        <tr>
            ...
            <td>
            	<input type="text" class="form-control" id="txt_RevisionNo"
            		   value="<%=targetCustVector.get(3).toString().trim()%>" readonly>
           	</td>
        </tr>
