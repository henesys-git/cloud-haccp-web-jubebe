	...
	function SaveOderInfo() {
		if ($('#txt_storage_no').val().length < 1) {
   		...
   		var dataJson = new Object(); // jSON Object 선언 
			...
			if(chekrtn){
// 				SendTojsp(urlencode(params),"M909S112100E102");
				SendTojsp(JSON.stringify(dataJson), "M909S112100E102"); // 보내는 데이터묶음 하나일때 => Object하나만
			}
	}
...
//	         	 alert(bomdata);
	         ...
	         success: function (html) {
	        	 if(html>-1){
	        		heneSwal.success('창고정보 수정에 성공하였습니다.');
...
//        $('#txt_StartDate').datepicker('update', fromday);
   ...
   <table class="table table-hover" style="width: 100%; margin: 0 auto; align:left">
        ...
        <tr style="background-color: #fff; height: 40px">
            <td>창고번호</td>
            <td> </td>
            <td ><input type="text" class="form-control" id="txt_storage_no" style="float:left" 
