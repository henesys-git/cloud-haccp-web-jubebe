...
<%
	...
	int startPageNo = 1;
/* =========================복사하여 수정 할 부분=================================================  */   
	String GV_PROC_CD="", GV_PROC_CD_REV="";
	...
	String param = GV_PROC_CD + "|"  + GV_PROC_CD_REV + "|";
    ...
    TableModel = new DoyosaeTableModel("M909S122100E174", jArray);	
...
/* =========================복사하여 수정 할 부분====끝=====================================  */  
	...
	String RightButton[][]	= {{"off", "fn_Chart_View", rightbtnChartShow},{"off", "fn_Doc_Reg()", rightbtnDocSave},{"off", "file_real_name", rightbtnDocShow}};
 	...
 	/* =========================복사하여 수정 할 부분=================================================  */ 
    makeGridData.htmlTable_ID	= "TableS909S122170";
    /* =========================복사하여 수정 할 부분====끝=====================================  */  
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
    	v<%=makeGridData.htmlTable_ID%> = $('#<%=makeGridData.htmlTable_ID%>').DataTable({	
    		scrollX: true,
    		scrollY: 330,
    	    scrollCollapse: true,
    	    paging: true,
...
<table class='table table-bordered nowrap table-hover' id="<%=makeGridData.htmlTable_ID%>" style="width: 100%">
		...
		<tr>
		     ...
		     <th style='width:0px; display: none;'>pic_seq</th>
		     <th>체크코드</th>
		     <th style='width:0px; display: none;'>체크개정번호</th>
		     <th>항목코드</th>
