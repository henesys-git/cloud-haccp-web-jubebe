...
/* =========================복사하여 수정 할 부분=================================================  */   
    ...
    TableModel = new DoyosaeTableModel("M909S090100E114", jArray);	
...
/* =========================복사하여 수정 할 부분====끝=====================================  */  
	...
	String RightButton[][]	= {{"off", "fn_Chart_View", rightbtnChartShow},{"off", "fn_Doc_Reg()", rightbtnDocSave},{"off", "file_real_name", rightbtnDocShow}};
 	...
 	/* =========================복사하여 수정 할 부분=================================================  */ 
    makeGridData.htmlTable_ID	= "tableS909S090110";
    /* =========================복사하여 수정 할 부분====끝=====================================  */  
...
<script type="text/javascript">
    ...
    function clickSubMenu(obj){
		...
		program_id	= td.eq(2).text().trim();
		user_id	= td.eq(5).text().trim();
		group_cd = td.eq(4).text().trim();
...
<table class='table table-bordered nowrap table-hover' id="<%=makeGridData.htmlTable_ID%>" style="width: 100%">
		...
		<tr>
		     ...
		     <th>메뉴레벨</th>
		     <th>그룹코드</th>
		     <th style='width:0px; display: none;'>user_id</th>
