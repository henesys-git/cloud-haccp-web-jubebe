...
// 체크항목 분할변수
	...
	function SetRecvData(){
		...
		DataPars(M909S030100E103, GV_RECV_DATA);
 		if(M909S030100E103.retnValue > 0)
 			alert('삭제 되었습니다.');
	...
	function SaveOderInfo() {
		...
		var delete_check = confirm("Rev(개정번호) 상관없이 해당 체크문항을 삭제합니다."+"\n"+"삭제하시겠습니까?");
		if(delete_check) {
...
//	         	 alert(bomdata);
	         ...
	         error: function (xhr, option, error) {
	        	 heneSwal.error('삭제에 실패하였습니다. 다시 시도해주세요.');
	         }
	     });		
	}
   ...
   <table class="table table-hover" style="width: 100%; margin: 0 auto; align:left">
        ...
        <tr style="background-color: #fff; height: 40px">
            ...
            <td >
            	<input type="text" class="form-control" id="txt_MunhangNote" style="width: 200px; float:left" 
            		value="<%=targetVector.get(3).toString()%>" readonly />
           	</td>
        </tr>
        ...
        <tr style="background-color: #fff; height: 40px">
            ...
            <td >
            	...
            	<input type="checkbox" id="txt_DoubleCheckYN" style="margin-left:5px; float:left;" disabled >Double Check 여부</input>
           	</td>
        </tr>
        ...
        <tr style="height: 40px">
            ...
            <td></td>
            <td >
            	<select class="form-control" id="select_ItemCode" style="width: 200px" disabled="disabled">
	                ...
	                <%for(int i=0; i<optCodeCode.size();i++){ %>
	                	<%if( optCodeCode.get(i).toString().equals(targetVector.get(7).toString())
	                		&& optCodeSeq.get(i).toString().equals(targetVector.get(8).toString()) ) { %>
				...
				<input type="hidden" class="form-control" id="txt_RevisionNo" style="width: 200px; float:left" 
        ...
        <tr style="background-color: #fff; height: 40px">
            ...
            <td >
            	<input type="text" data-date-format="yyyy-mm-dd" id="txt_StartDate" class="form-control"
                	style="width: 220px; border: solid 1px #cccccc;" disabled="disabled" />
