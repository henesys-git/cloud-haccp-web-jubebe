...
<%
	...
	String  GV_SULBI_CD="", GV_REVISION_NO;
...
//     		var new_chulha_amount = Number($('#txt_chulha_cnt').val().replace(/,/gi,'')) * Number($('#txt_chulha_unit_price').val().replace(/,/gi,''));
	...
	function SetRecvData(){
		DataPars(M909S180100E301, GV_RECV_DATA);  	
 		if(M909S180100E301.retnValue > 0)
 			alert('등록 되었습니다.');
		...
		<td style="width: 70%;">
   			<table class="table table-bordered" style="width: 100%; margin: 0 auto; align:left">
		        ...
		        <tr style="background-color: #fff" >
		            ...
		            <td  colspan="3"> <input type="text" data-date-format="yyyy-mm-dd" id="txt_GigwanName" class="form-control" style="width: 400px; border: solid 1px #cccccc;" /></td>		        
		        </tr>
		        ...
		        <tr>
		            <td colspan="6"><textarea class="form-control" id="txt_WorkMemo"  style="cols:10;rows:4;resize: none;" ></textarea></td>		           
		        </tr>

				<tr style="background-color: #fff;">
		            <td style=" font-weight: 900; font-size:14px; text-align:left">반출일자</td>
		            <td ><input type="text" data-date-format="yyyy-mm-dd" id="txt_StartDate" class="form-control" style="width: 150px; border: solid 1px #cccccc;"/></td>
		            <td style=" font-weight: 900; font-size:14px; text-align:left">완료일자</td>
		            <td> <input type="text" data-date-format="yyyy-mm-dd" id="txt_EndDate" class="form-control" style="width: 150px; border: solid 1px #cccccc;"/></td>		        
		        </tr>

		        <tr style="background-color: #fff; ">
		         	<td style=" font-weight: 900; font-size:14px; text-align:left">담당자</td>
		            <td><input type="text"  id="txt_DamdangJa" class="form-control" style="width: 150px; border: solid 1px #cccccc; vertical-align: middle;"/></td>
		            <td style=" font-weight: 900; font-size:14px; text-align:left" >비용</td>
		            <td  colspan="3"> <input type="text" numberOnly id="txt_Biyong" class="form-control" style="width: 150px; border: solid 1px #cccccc; vertical-align: middle;"/></td>		           
		        </tr>
		        ...
		        <tr>
		            <td colspan="6"><textarea class="form-control" id="txt_Bigo"  style="cols:10;rows:4;resize: none;" ></textarea></td>		           
		        </tr>
