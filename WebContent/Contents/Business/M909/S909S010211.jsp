...
<script type="text/javascript">
    ...
    $(document).ready(function () {
    	...
    	console.log('<%=GV_PROD_CD%>');
    	console.log('<%=GV_REVISION_NO%>');
    ...
    if(formId == 'form1'){ //배합정보 등록 추가 버튼 클릭했을 때
	...
	function saveData(){
		...
		if(checkValue == '' || checkValue == undefined){ //원부자재 정보 1개 이상 추가 안하고 저장 누를 떄 예외처리
			heneSwal.warning('배합정보를 등록할 원부자재 정보를 하나 이상 추가해 주세요.');
			return false;	
		}
		...
		if(result){
			SendTojsp(jsonStr, "M909S010100E001");
		} else{
                    ...
                    <form class="form-horizontal" id="form1">
	                    <div class="card-body">
	                        <div class="form-group row">
		                        ...
		                        <div class="col-sm-8">
		                            <input type="text" class="form-control" id="inputBox1" readonly/>
