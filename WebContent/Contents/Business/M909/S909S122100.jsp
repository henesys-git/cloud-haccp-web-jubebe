...
/* =========================복사하여 수정 할 부분=================================================  */   
	...
	if(GV_REV_CHECK.equals("true")) GV_PID = "M909S1220100E104";
	else if(GV_REV_CHECK.equals("false")) GV_PID = "M909S122100E105";
...
/* =========================복사하여 수정 할 부분====끝=====================================  */  
	...
	String RightButton[][]	= {{"off", "fn_Chart_View", rightbtnChartShow},{"off", "fn_Doc_Reg()", rightbtnDocSave},{"off", "file_real_name", rightbtnDocShow}};
 	...
 	/* =========================복사하여 수정 할 부분=================================================  */ 
    makeGridData.htmlTable_ID	= "tableS909S122100";
    /* =========================복사하여 수정 할 부분====끝=====================================  */  
...
<script type="text/javascript">
    ...
    function clickMainMenu(obj){
		...
		vProcess_gubun = td.eq(0).text().trim();
		process_nm = td.eq(3).text().trim();
		proc_cd 	= td.eq(1).text().trim();
		proc_cd_rev = td.eq(2).text().trim();
		// 서브 메뉴를 보여준다.
		fn_DetailInfo_List();
    }
    /* =========================복사하여 수정 할 부분====끝=====================================  */ 
