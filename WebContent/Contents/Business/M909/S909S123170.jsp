...
/* =========================복사하여 수정 할 부분=================================================  */   
    ...
    TableModel = new DoyosaeTableModel("M909S123100E174", jArray);	
...
/* =========================복사하여 수정 할 부분====끝=====================================  */  
	...
	String RightButton[][]	= {{"off", "fn_Chart_View", rightbtnChartShow},{"off", "fn_Doc_Reg()", rightbtnDocSave},{"off", "file_real_name", rightbtnDocShow}};
 	...
 	/* =========================복사하여 수정 할 부분=================================================  */ 
    makeGridData.htmlTable_ID	= "TableS909S123170";
    /* =========================복사하여 수정 할 부분====끝=====================================  */  
...
<script type="text/javascript">
    ...
    function <%=makeGridData.htmlTable_ID%>Event(obj){
		...
		prod_cd		= td.eq(2).text().trim();
		prod_cd_rev = td.eq(3).text().trim();
	 	fn_DetailInfo_List();
