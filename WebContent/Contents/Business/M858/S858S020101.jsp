...
%>
    ...
    $(document).ready(function () {
        ...
        $('#txt_baecha_start_dt').data('daterangepicker').setStartDate(today);
        today.setHours(17,0,0);
        $('#txt_baecha_end_dt').data('daterangepicker').setStartDate(today);
    ...
    function call_S858S020130(){
        $.ajax({
	        ...
	        data: "caller=" + "S858S020101" + "&baecha_no=" + "<%=GV_BAECHA_NO%>",
	        beforeSend: function () {
