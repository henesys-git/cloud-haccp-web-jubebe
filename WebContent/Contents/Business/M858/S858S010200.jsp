...
<%
    ...
    TableModel = new EdmsDoyosaeTableModel("M404S010700E104", jArray);
    ...
    makeGridData.htmlTable_ID	= "tableS404S010700";
...
// 		{"내외부구분","문서코드", "문서명", "문서구분코드", "문서구분", "파일명","등록번호","변경번호", 
//		 "실파일명"  ,"외부문서", "등록사유", "파기사유","총페이지", "관리본여부","보관여부","보존여부","등록일자", "등록자"} ;	
