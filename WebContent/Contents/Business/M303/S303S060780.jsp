...
<%
	...
	String[] TR_Style		= {"",""};
// 	String[] TR_Style		= {""," onclick='S303S060780Event(this)' "};
...
//     makeTableHTML.htmlTable_ID	= "TableS303S060780";
...
var vTableS303S060780;
var TableS303S060780_info;
var TableS303S060780_RowCount;
var S303S060780_Row_index = -1;

var item_type = [];


    $(document).ready(function () {	
		vTableS303S060780=$('#order_product_result_table').DataTable({    	    
			scrollX: true,
			scrollY: 470,
		    scrollCollapse: true,
		    paging: false,
...
// 			S303S060780_Row_index = vTableS303S060780
// 		        .row( this )
// 		        .index();		
// 		});
...
// 				alert($(this).closest('tr').preveAll().length);
		 		$($("input[id='txt_item_type']")[S303S060780_Row_index]).on("click", function(){
					if($($("input[id='txt_item_type']")[S303S060780_Row_index]).prop('checked')){
						$(this).attr("checked", true);
						item_type[S303S060780_Row_index]="Y";
	//						$($("input[id='txt_pass_yn']")[S303S060780_Row_index]).attr("checked", true);
		 			}
					else{
						$(this).attr("checked", false);
						item_type[S303S060780_Row_index]="N";
						
	//						$($("input[id='txt_pass_yn']")[S303S060780_Row_index]).attr("checked", false);
					}	
			    }); 			
			});
...
// 			vTableS303S060780.row(this)
// 		    .nodes()
// 		    .to$()
// 		    .attr("class", "hene-bg-color_w");
// 		} );

    function S303S060780Event(obj){
    	var tr = $(obj);
		var td = tr.children();
