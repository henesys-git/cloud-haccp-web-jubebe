	...
	<div class="col-md-12">
		<table class="table" style="width: 100%">
			...
			<tr>
		        ...
		        <td>
		        	<input type="number" id="blendingAmtReal" class="form-control" value="<%=blendingAmtReal%>"/>
		        </td>
		    </tr>
			<tr>
				<td>
...
<script>
		...
		$.ajax({
	        ...
	        success: function (receive) {
				if(receive > -1) {
					...
					heneSwal.success('원료배합량이 입력되었습니다');
				} else {
					heneSwal.error('원료배합량 입력 실패했습니다, 다시 시도해주세요')
				}
	         }
	    });
	}
	...
	function setBlendingSubTable(data) {
    	...
    	/* $('#blendingTable tbody').on( 'change', 'td', function () {
    		console.log($('#inputId0').val())
    	} ); */
