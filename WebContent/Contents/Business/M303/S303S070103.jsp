...
%>
    ...
    function call_S303S070130(){
        $.ajax({
	        ...
	        data: "order_no=" +  "<%=GV_ORDERNO%>"  + "&order_detail_seq=" + "<%=GV_ORDER_DETAIL_SEQ%>"+ "&caller=" + "S303S070102"
	        		+ "&lotno=" + '<%=GV_LOTNO%>', 
	        beforeSend: function () {
	...
	function SaveOderInfo() {        
		if(S303S070130_Row_index == -1) {
            ...
            var dataJson = new Object();
    	    	dataJson.order_no 		= vTableS303S070130.cell(S303S070130_Row_index , 0).data(); 	//order_no 
    	    	dataJson.lotno 			= vTableS303S070130.cell(S303S070130_Row_index , 1).data(); 	//lotno
    	    	dataJson.bulchul_req_no = vTableS303S070130.cell(S303S070130_Row_index , 2).data();	//bulchul_req_no : 이미 조회된 데이터가 있을경우 0번째 행의 bulchul_req_no, 없을 경우 'ㅋ'(가짜값)
    	    	dataJson.part_cd 		= vTableS303S070130.cell(S303S070130_Row_index , 3).data(); 	//part_cd
    	    	dataJson.part_cd_rev 	= vTableS303S070130.cell(S303S070130_Row_index , 4).data(); 	//part_cd_rev
