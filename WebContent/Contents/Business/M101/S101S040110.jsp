...
// 	final int PageSize=15; 
	...
	String[] strColumnHead 	= {"주문번호","제품번호","제품명","주문상세번호","시리얼번호", "LOT수량", "LOT NO","LOT수량","비고"};
	int[] colOff 			= { 1, 	   1, 		1, 		0,			0,		 0,		  1,		1,		1};
	String[] TR_Style		= {""," onclick='S101S020110Event(this)' "};
    ...
    TableModel = new DoyosaeTableModel("M101S040100E114", strColumnHead, jArray);	
