...
<%
	...
	String param = GV_ORDER_NO + "|" + GV_JSPPAGE + "|" + member_key + "|";	
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
    	...
    	fn_DocGubun_check(); // 문서출처구분에 따라 출처 입력칸 활성화/비활성화 52428800
    	$('#iDfilename1').bind('change', function(){
    		if( (this.files[0].size / 1024 / 1024) > 50 ) {
    			alert("50MB 이상Upload 제한합니다."); 
    		}
    	});
    });
    ...
    function submitForm(){
    	...
    	// 문서코드를 선택 안했을 경우 법중 추가
    	if($('#iDfilename1').val().length > 1 && $('#txt_doccode1').val() == ""){
    		alert("문서#1 문서코드를 등록하여 주세요.");
    		return false;
    	}
    	if($('#iDfilename2').val().length > 1 && $('#txt_doccode2').val() == ""){
    		alert("문서#2 문서코드를 등록하여 주세요.");
    		return false;
    	}
    	if($('#iDfilename3').val().length > 1 && $('#txt_doccode3').val() == ""){
    		alert("문서#3 문서코드를 등록하여 주세요.");
    		return false;
    	}
    	if($('#iDfilename4').val().length > 1 && $('#txt_doccode4').val() == ""){
    		alert("문서#4 문서코드를 등록하여 주세요.");
    		return false;
    	}
    	if($('#iDfilename5').val().length > 1 && $('#txt_doccode5').val() == ""){
    		alert("문서#5 문서코드를 등록하여 주세요.");
    		return false;
    	}
    	
    	// 파일을 선택 안했을 경우 법중 추가
    	if($('#iDfilename1').val().length < 1 && $('#txt_doccode1').val().length > 1){
    		alert("문서#1 파일을 선택하여 주세요.");
    		return false;
    	}
    	if($('#iDfilename2').val().length < 1 && $('#txt_doccode2').val().length > 1){
    		alert("문서#2 파일을 선택하여 주세요.");
    		return false;
    	}
    	if($('#iDfilename3').val().length < 1 && $('#txt_doccode3').val().length > 1){
    		alert("문서#3 파일을 선택하여 주세요.");
    		return false;
    	}
    	if($('#iDfilename4').val().length < 1 && $('#txt_doccode4').val().length > 1){
    		alert("문서#4 파일을 선택하여 주세요.");
    		return false;
    	}
    	if($('#iDfilename5').val().length < 1 && $('#txt_doccode5').val().length > 1){
    		alert("문서#5 파일을 선택하여 주세요.");
    		return false;
    	}
        ...
        data.append("lotno",	 	$('#txt_lotno').val()); //20190108 진욱추가
    	...
    	if($('#iDfilename1').val().length < 1 && $('#iDfilename2').val().length < 1 && 
    	   $('#iDfilename3').val().length < 1 && $('#iDfilename4').val().length < 1 && 
    	   $('#iDfilename5').val().length < 1) {
    		alert("등록할 파일을 선택하세요.");
    		return false;
    	} else{
    	    $.ajax({
    	        ...
    	        success: function (data) {
					...
					if(data.length>0){
                    	var vData = decodeURIComponent(data)
                    	alert("성공 : "+ vData + "이 성공적으로 등록 되었습니다.");                		
    ...
    function fn_DocGubun_check() {
    	if($("#select_DocGubunReg").val().trim() == "DOCREG02") { // 외부문서일 때
	...
	<table class="table " style="width: 100%; margin: 0 auto; align:left">
		<tr style="height: 40px">
    		<td style="font-weight: 900; font-size:14px; text-align:left">문서출처구분</td>
	            <td>
	            	<input type="hidden" class="form-control" id="txt_Reg_reason" name="reg_reason" style="width: 150px" readonly/>
	 		...
	 		<tr style="height: 40px">
	            ...
	            <td>
	            	<input type="text" class="form-control" id="txt_external_doc_source" name="external_doc_source" style="width: 70%; float:left;" />
	            </td>
	            <td></td>
	        </tr>
	        <tr>
		        		...
		        		<tbody id="Doc_tbody">
							<tr style="height:40px; vertical-align: middle"> 
					            ...
					            <td style="width:80%; font-weight: 900; font-size:14px; text-align:left; vertical-align: middle">
									<input type="text" class="form-control" id="txt_docname1" name="docname1" style="width: 250px; float:left" readonly/>
									<input type="hidden" class="form-control" id="txt_doccode1" name="doccode1" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_rev_no1" name="rev_no1" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_doc_gubun1" name="doc_gubun1" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_JobType" value="INSERT" name="JobType" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_pid" name="pid" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_user_id" name="user_id" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_orderno" name="orderno" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_order_detail" name="order_detail" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_lotno" name="lotno" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_jspPage" name="jspPage" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_getnum_prefix" name="getnum_prefix" style="width: 150px" readonly/>
									<button type="button" onclick="parent.pop_fn_DocName_View(1,0,'<%=GV_DOC_GUBUN_DEFAULT%>','')" 
											id="btn_SearchProd" class="btn btn-info" style=" margin-left:10px;float:left">
										문서코드
									</button> 
					           	</td>
					        </tr>       
					        <tr style="height: 40px; vertical-align: middle">
					            ...
					            <td style=" font-weight: 900; font-size:14px; text-align:left; vertical-align: middle">
									<input type="text" class="form-control" id="txt_docname2" name="docname2" style="width: 250px; float:left" readonly/>
									<input type="hidden" class="form-control" id="txt_doccode2" name="doccode2" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_rev_no2" name="rev_no2" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_doc_gubun2" name="doc_gubun2" style="width: 150px" readonly/>
									<button type="button" onclick="parent.pop_fn_DocName_View(1,1,'<%=GV_DOC_GUBUN_DEFAULT%>','')" 
											id="btn_SearchProd" class="btn btn-info" style="margin-left:10px;float:left">
										문서코드
									</button> 
					           	</td>
					        ...
					        <tr style="height: 40px; vertical-align: middle">
					            ...
					            <td style="font-weight: 900; font-size:14px; text-align:left; vertical-align: middle">
									<input type="text" class="form-control" id="txt_docname3" name="docname3" style="width: 250px; float:left" readonly/>
									<input type="hidden" class="form-control" id="txt_doccode3" name="doccode3" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_rev_no3" name="rev_no3" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_doc_gubun3" name="doc_gubun3" style="width: 150px" readonly/>
									<button type="button" onclick="parent.pop_fn_DocName_View(1,2,'<%=GV_DOC_GUBUN_DEFAULT%>','')" 
										id="btn_SearchProd" class="btn btn-info" style="margin-left:10px;float:left">
										문서코드
									</button> 
					           	</td>
					        ...
					        <tr style="height: 40px; vertical-align: middle">
					            ...
					            <td style="font-weight: 900; font-size:14px; text-align:left; vertical-align: middle">
									<input type="text" class="form-control" id="txt_docname4" name="docname4" style="width: 250px; float:left" readonly/>
									<input type="hidden" class="form-control" id="txt_doccode4" name="doccode4" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_rev_no4" name="rev_no4" style="width: 150px" readonly/>
									<input type="hidden" class="form-control" id="txt_doc_gubun4" name="doc_gubun4" style="width: 150px" readonly/>
					        ...
					        <tr style="height: 40px; vertical-align: middle">
					            ...
					            <td style="font-weight: 900; font-size:14px; text-align:left; vertical-align: middle">
									<input type="text" class="form-control" id="txt_docname5" name="docname5" style="width: 250px; float:left" readonly />
									<input type="hidden" class="form-control" id="txt_doccode5" name="doccode5" style="width: 150px" readonly />
									<input type="hidden" class="form-control" id="txt_rev_no5" name="rev_no5" style="width: 150px" readonly />
									<input type="hidden" class="form-control" id="txt_doc_gubun5" name="doc_gubun5" style="width: 150px" readonly />
