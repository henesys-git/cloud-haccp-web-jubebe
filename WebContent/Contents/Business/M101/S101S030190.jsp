...
/* 
	S101S030190.jsp 
	S101S030131.jsp : 주문별 제품검사체크리스트 등록 화면 의 M101S020100E104
	하단 체크리스트 목록
*/
	...
	String[] TR_Style		= {""," onclick='S101S030190Event(this)' "};
    ...
    TableModel = new DoyosaeTableModel("M101S030100E194", strColumnHead, jArray);
    ...
    makeTableHTML.htmlTable_ID	= "TableS101S030190";
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		vTableS101S030190 = $('#<%=makeTableHTML.htmlTable_ID%>').DataTable({
			scrollX: true,
		    scrollY: 330,
		    scrollCollapse: true,
		    paging: false,
...
// 	      		$(row).attr('onclick',"S101S030190Event(this)");
// 	      		$(row).attr('role',"row");
// 	  		},
	  		'columnDefs': [{ 
		...
		$('#<%=makeTableHTML.htmlTable_ID%> tbody').on( 'click', 'tr', function () {
			TableS101S030190_Row_Index = vTableS101S030190
		        .row( this )
		        .index();
			$('#btn_plus').html("수정");
		} );
