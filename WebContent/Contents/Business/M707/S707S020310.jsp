...
// 	jArray.put( "todate", Todate);
    ...
    TableModel = new DoyosaeTableModel("M707S020300E314", jArray);	
...
/* =========================복사하여 수정 할 부분====끝=====================================  */  
	...
	String RightButton[][]	= {{"off", "fn_Chart_View", rightbtnChartShow},{"off", "fn_Doc_Reg()", rightbtnDocSave},{"off", "file_real_name", rightbtnDocShow}};
 	...
 	/* =========================복사하여 수정 할 부분=================================================  */ 
    makeGridData.htmlTable_ID	= "TableS707S020310";
    /* =========================복사하여 수정 할 부분====끝=====================================  */  
...
//  	System.out.println("1212 click 날짜 : " + Todate );
//  	System.out.println("1212 makeGridData.getDataArry() : " + makeGridData.);
%>
...
<!-- 		style='width:0px; display: none;' -->
		     ...
		     <th>날짜</th>
		     <th>총 인건비</th>
		     <th style='width:0px; display: none;'>원자재코드</th>
		     <th>원자재명</th>
		     <th>단가</th>
		     <th>수량</th>
		     <th>합계</th>
