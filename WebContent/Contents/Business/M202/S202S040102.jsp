...
*/
	...
	String GV_PART_CD="",GV_PART_CD_REV="", GV_IPGO_NO="", GV_PART_NAME="", GV_MACHINENO="",GV_RAKES="",GV_PLATE="",GV_COLM="",GV_IO_AMT="",GV_PRE_AMT="",
			GV_POST_AMT="",GV_PARTGUBUN_BIG="",GV_PARTGUBUN_MID="", GV_IO_SEQNO="", 
			 GV_lMACHINENO="",GV_lRAKES="",GV_lPLATE="",GV_lCOLM="",GV_lIO_AMT="",GV_lPRE_AMT="",GV_lPOST_AMT="",GV_BALJUNO="";
...
%>
    ...
    function call_S202S040140() {
    	$.ajax({
	        type: "POST",
	        async: false,
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S040140.jsp", 
...
//     }
	...
	function SaveOderInfo() { 
		...
		if($('#txt_store_no').val()=='' || $('#txt_reakes_no').val()=='' ||
		    ...
		    dataJson.ipgo_no		= ipgo_no;			//0 ipgo_no
		    dataJson.chulgo_no		= chulgo;			//0 chulgo_no
		    ...
		    dataJson.hist_no		= $('#txt_hist_no').val();
			...
			var pID="";
			if(qa1=="IPG")		pID = "M202S030100E101"
			else if(qa1=="CHL")	pID = "M202S040100E101"
		...
		<div style="width: 650px;float: left; vertical-align: top">					
        	...
        	<table class="table table-striped" style="width: 100%; margin: 0 ; align:left ;" id="bom_table">
	        	...
	        	<tr style="vertical-align: middle">
	        		...
	        		<td>
	        			<input type="text" 	 class="form-control" id="txt_store_no"  style="width:100px;float: left;"  ></input>
