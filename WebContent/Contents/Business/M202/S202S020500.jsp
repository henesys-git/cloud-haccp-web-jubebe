...
<%
	...
	TableModel = new DoyosaeTableModel("M202S020500E104", jArray);
    ...
    makeGridData.htmlTable_ID	= "tableS202S010100";
...
// 	 	vOrderDetailSeq = td.eq(12).text().trim();  
	 	vLotNo 			= td.eq(6).text().trim(); 
	 	vBaljuNo		= td.eq(26).text().trim();
