...
<%
	...
	String[] strColumnHead 	= {"원부자재명","원부자재코드","part_cd_rev","revision_no","입고전재고","창고","렉","선반","칸"};
...
// 	String[] TR_Style		= {""," onclick='S202S020120Event(this)' "};
	...
	String GV_PART_CD="",GV_ORDER_NO="",GV_PART_CD_REV;
    ...
    makeTableHTML.htmlTable_ID	= "TableS202S120220";
...
<script>
    $(document).ready(function () {
		...
		vTableS202S120220 = $('#<%=makeTableHTML.htmlTable_ID%>').DataTable({
			scrollX: true,
		    scrollY: 340,
		    scrollCollapse: true,
		    paging: false,
...
// 	      		$(row).attr('onclick',"S202S010120Event(this)");
		...
		$('#<%=makeTableHTML.htmlTable_ID%> tbody').on( 'click', 'tr', function () {
			S202S120220_Row_index = vTableS202S120220
		        .row( this )
		        .index();
...
// 		    });
			...
			vTableS202S120220.row(this)
		    .nodes()
		    .to$()
		    .attr("class","hene-bg-color");
			clear_input();
	
			$('#txt_part_name').val(vTableS202S120220.cell(S202S120220_Row_index, 0).data());		//7 원부자재명
			$('#txt_part_cd').val(vTableS202S120220.cell(S202S120220_Row_index, 1).data());		//6 파트코드
			$('#txt_part_cd_rev').val(vTableS202S120220.cell(S202S120220_Row_index, 2).data());		//6 파트코드
			$('#txt_pre_amt').val(vTableS202S120220.cell(S202S120220_Row_index, 4).data());		//14 입고전재고
			$('#txt_store_no').val(vTableS202S120220.cell(S202S120220_Row_index, 5).data());
			$('#txt_rakes_no').val(vTableS202S120220.cell(S202S120220_Row_index, 6).data());
			$('#txt_plate_no').val(vTableS202S120220.cell(S202S120220_Row_index, 7).data());
			$('#txt_colm_no').val(vTableS202S120220.cell(S202S120220_Row_index, 8).data());
