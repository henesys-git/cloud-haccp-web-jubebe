...
<%
    ...
    TableModel = new DoyosaeTableModel("M202S010100E234", strColumnHead, param);
...
// 	            TableS202S010240_RowCount = TableS202S010240_info.recordsTotal;
	            ...
	            for(var i=0; i<TableS202S010240_RowCount+1; i++){
	    			$($("#TableS202S010240 tr")[i]).find("td").eq(14).prop('style', 'width:0px; display: none;');
	    			$($("#TableS202S010240 tr")[i]).find("th").eq(14).prop('style', 'width:0px; display: none;');
	            }
	        },
	...
	function SaveOderInfo() {    
		...
		if(chekrtn){
			parmHead += '<%=GV_JSPPAGE%>'		+ "|"
    				  ...
    				  + '<%=Config.DATATOKEN%>' \
					;	
			SendTojsp(urlencode(parmHead), "M202S010100E222");
