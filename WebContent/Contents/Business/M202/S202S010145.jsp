...
<%
	...
	int[]   colOff 			= { 0,  0, 10, 12, 0, 1,0,1,1,1,1,1,0};//전체 넓이 번튼 3개:86%, 문서2개:90%, 문서뷰:94%, 챠트보기,문서등록91%; 고객사
...
//     TableModel = new DoyosaeTableModel("M202S010100E144", strColumnHead, param);	
	TableModel = new DoyosaeTableModel("M202S010100E144", strColumnHead, jArray);	
    ...
    makeTableHTML.htmlTable_ID	= "TableS202S010145";
...
<script>
    $(document).ready(function () {
		...
		vTableS202S010145 = $('#<%=makeTableHTML.htmlTable_ID%>').DataTable({
			scrollX: true,
// 		    scrollY: 380,
// 		    scrollCollapse: true, HENESYS_MES_SERVER_WEB
		    paging: false,
...
// 			S202S010145_Row_index = vTableS202S010145
// 		        .row( this )
// 		        .index();


<%-- 	 		$(<%=makeTableHTML.htmlTable_ID%>_rowID).removeClass("hene-bg-color"); --%>
// 			vTableS202S010145.row(this)
// 		    .nodes()
// 		    .to$()
