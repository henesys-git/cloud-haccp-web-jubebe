...
// 	String param =GV_ORDERNO+ "|" ;
    ...
    // TableModel = new DoyosaeTableModel("M202S030100E144", strColumnHead, param);
...
//  웹소켓 통신을 위해서 필요한 변수들 ---끝	
	...
	var TableS202S030120_info;
    var TableS202S030120_RowCount;
    var S202S030120_Row_index = -1;    

    var vTableS202S030140;
	var TableS202S030140_info;
    var TableS202S030140_RowCount;
    var S202S030140_Row_index = -1;    
...
//     var balju_inspect_no="";
    ...
    $(document).ready(function () {
		...
		$('#txt_order_detail_seq').val('<%=GV_ORDER_DETAIL_SEQ%>');
		 ...
		 $.ajax({
		        type: "POST",
	            url: "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S030120.jsp", 
        ...
        $.ajax({
	        type: "POST",
            url: "<%=Config.this_SERVER_path%>/Contents/Business/M202/S202S030140.jsp", 
	        data: "order_no=" + '<%=GV_ORDERNO%>' + "&caller=" + "S202S020101"  , 
	        beforeSend: function () {
	...
	function SaveOderInfo() {        
		...
		TableS202S030140_info = vTableS202S030140.page.info();
        TableS202S030140_RowCount = TableS202S030140_info.recordsTotal;
		...
		var parmBody= "" ;
	    for(var i=0; i<TableS202S030140_RowCount; i++){   
	    	parmBody += vTableS202S030140.cell(i , 0).data() + "|"	//0 주문번호
	    	+ vTableS202S030140.cell(i , 1).data() + "|"	//1 입고번호
	    	+ vTableS202S030140.cell(i , 2).data() + "|"	//2 입고일자
	    	+ vTableS202S030140.cell(i , 3).data() + "|"	//3 입고일련번호					
	    	+ vTableS202S030140.cell(i , 4).data() + "|"	//4 입고시간
	    	+ vTableS202S030140.cell(i , 5).data() + "|"	//5 입고담당자
	    	+ vTableS202S030140.cell(i , 6).data() + "|"	//6 원부자재명
	    	+ vTableS202S030140.cell(i , 7).data() + "|"	//7 원부자재코드\
	    	+ vTableS202S030140.cell(i , 8).data() + "|"	//8 원부자재개정번호
	    	+ vTableS202S030140.cell(i , 9).data() + "|"	//9 창고번호
	    	+ vTableS202S030140.cell(i , 10).data() + "|"	//10 렉번호
	    	+ vTableS202S030140.cell(i , 11).data() + "|"	//11 선반번호
	    	+ vTableS202S030140.cell(i , 12).data() + "|"	//12 칸번호
	    	+ vTableS202S030140.cell(i , 13).data() + "|"	//13 입고 전 재고량
	    	+ vTableS202S030140.cell(i , 14).data() + "|"	//14 입고 후 재고량
 	    	+ vTableS202S030140.cell(i , 15).data() + "|"	//15 입출고 수량
			+ '<%=member_key%>' 					+ "|"
			+ '<%=Config.DATATOKEN %>'
			;
	    }
...
// 	         	 alert(bomdata);
    ...
    function fn_Update_body(obj){  	
    	if(S202S030140_Row_index == -1){
    		vTableS202S030140.row.add( [
    			$('#txt_ipgo_order').val(),
    			$('#txt_ipgo_no').val(),
    			$('#txt_ipgo_date').val(),
    			++ioSeq_Max,
...
//     			'';
    		...
    		vTableS202S030140.cell( S202S030140_Row_index, 0).data( $('#txt_ipgo_order').val() );
    		vTableS202S030140.cell( S202S030140_Row_index, 1).data( $('#txt_ipgo_no').val() );
			vTableS202S030140.cell( S202S030140_Row_index, 2).data( $('#txt_ipgo_date').val() );
			vTableS202S030140.cell( S202S030140_Row_index, 3).data( $('#txt_io_seqno').val() );
			vTableS202S030140.cell( S202S030140_Row_index, 4).data( $('#txt_io_time').val() );
			vTableS202S030140.cell( S202S030140_Row_index, 5).data( $('#txt_io_user_id').val() );
			vTableS202S030140.cell( S202S030140_Row_index, 6).data( $('#txt_part_name').val() );
			vTableS202S030140.cell( S202S030140_Row_index, 7).data( $('#txt_part_cd').val() );
			vTableS202S030140.cell( S202S030140_Row_index, 8).data( $('#txt_partcd_bunho').val() );
			vTableS202S030140.cell( S202S030140_Row_index, 9).data( $('#txt_store_no').val() );
			vTableS202S030140.cell( S202S030140_Row_index, 10).data( $('#txt_reakes_no').val() );
			vTableS202S030140.cell( S202S030140_Row_index, 11).data( $('#txt_plate_no').val() );
			vTableS202S030140.cell( S202S030140_Row_index, 12).data( $('#txt_colm_no').val() );
			vTableS202S030140.cell( S202S030140_Row_index, 13).data( $('#txt_pre_amt').val() );
			vTableS202S030140.cell( S202S030140_Row_index, 14).data( $('#txt_io_count').val() );
			vTableS202S030140.cell( S202S030140_Row_index, 15).data( $('#txt_post_stack').val() );

    	}
    	vTableS202S030140.draw();
	    clear_input(); 
    }  
...
// 		$('#txt_balju_inspect_no').val("");	
    ...
    function fn_mius_body(obj){
		...
		console.log(trNum + "==fn_Update_body=" + S202S030140_Row_index); 
    	vTableS202S030140.row(S202S030140_Row_index ).remove().draw();
//     	vTableS202S030140.row(trNum ).remove().draw();

	    TableS202S030140_info = vTableS202S030140.page.info();
	    TableS202S030140_RowCount = TableS202S030140_info.recordsTotal;
	    
		for(var i =0; i<TableS202S030140_RowCount; i++){
		    vTableS202S030140.cell( i, 3 ).data( i+1 );
		}	        
    }
    function sum(obj){
    	if($("#txt_pre_amt").val()==""){$("#txt_pre_amt").val(0);}
    	var pre_amt = parseInt($("#txt_pre_amt").val());
    	var io_count = parseInt($("#txt_io_count").val());
    	$('#txt_post_stack').val(pre_amt + io_count);
    }
...
<!-- 	            <td style="width:  3%; font-weight: 900; font-size:14px; text-align:center; vertical-align: middle">순번</td> -->
	            ...
	            <td style="width: 10%; font-weight: 900; font-size:14px; text-align:center; vertical-align: middle ">수입검사</td>
	            ...
	            <td style="width:5.5%; font-weight: 900; font-size:14px; text-align:center; vertical-align: middle">입고전재고</td>
	            <td style="width:5.5%; font-weight: 900; font-size:14px; text-align:center; vertical-align: middle">입고수량</td>
	            <td style="width:6%; font-weight: 900; font-size:14px; text-align:center; vertical-align: middle">입고후재고</td>
...
<!-- 	            <td style="width:3.5%; font-weight: 900; font-size:14px; text-align:center; vertical-align: middle">Rev.</td> -->
	        ...
	        <tr style="vertical-align: middle">	
	        	...
	        	<td style="text-align:center; vertical-align: middle ;margin: 0 ;">
					...
					<input type="text" class="form-control"  id="txt_part_name" readonly></input>					
				</td>		           
	        	...
	        	<td style="text-align:center; vertical-align: middle ;margin: 0 ;">
						...
						<input type="text" class="form-control" id="txt_request_cnt"  readonly></input>
				</td>
	            <td style="text-align:center; vertical-align: middle ;margin: 0 ;">
					
	           		<input type="text" 	 class="form-control" id="txt_store_no"  ></input>
	           	</td>
	           	<td style="text-align:center; vertical-align: middle ;margin: 0 ;">
					 <input type="text" 	 class="form-control" id="txt_reakes_no"  ></input>       
	           	</td>
	            <td style="text-align:center; vertical-align: middle ;margin: 0 ;">
					<input type="text" 	 class="form-control" id="txt_plate_no"  ></input>
	           	</td>
	            ...
	            <td style="font-weight: 900; font-size:14px; text-align:center; vertical-align: middle ;margin: 0 ;">
	            	...
	            	<input type="text" 	 class="form-control" id="txt_colm_no"  ></input>
	            </td>
	            <td style="text-align:center; vertical-align: middle ;margin: 0 ;">
					<input type="text" 	 class="form-control" id="txt_pre_amt" readonly ></input>
	           	</td>
	           	<td style="text-align:center; vertical-align: middle ;margin: 0 ;">
					<input type="text" 	 class="form-control" id="txt_io_count" onchange="sum(this)" ></input>
	           	</td>
	           	<td style="text-align:center; vertical-align: middle ;margin: 0 ;">
					<input type="text" 	 class="form-control" id="txt_post_stack" readonly></input>
...
<!-- 	</div>         -->
        ...
        <p style="text-align:center;">
        	<button id="btn_Save"  class="btn btn-info"  onclick="SaveOderInfo();">자재입고수정</button>
