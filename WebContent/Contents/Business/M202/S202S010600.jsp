...
// 	final int PageSize=15; 
	...
	String[] strColumnHead = { "창고", "렉", "트레이", "칸", "원부자재코드",  "원부자재명", "원부자재위치","입출고량", "입출고전재고","재고","안전재고","part_cd_rev","비고" }; 
	int[]   colOff 			= {0,	0	,0 ,0,5,6,1,7,8 ,9 ,1, 0, 1};//전체 넓이 번튼 3개:86%, 문서2개:90%, 문서뷰:94%, 챠트보기,문서등록91%;
	String[] TR_Style		= {""," onclick='S202S010600Event(this)' "};
...
//     TableModel = new DoyosaeTableModel("M202S010100E604", strColumnHead, param);
    TableModel = new DoyosaeTableModel("M202S010100E604", strColumnHead, jArray);
    ...
    makeTableHTML.htmlTable_ID	= "TableS202S010600";
...
//                 {
//                     extend: 'excelHtml5',
//                     title: "대체적용 품목" + exportDate.format("yyyyMMdd_hhmmss"),
// 					exportOptions: {
