...
<%
	...
	String[] strColumnHead 	= {"창고","렉","선반","칸","원부자재코드","개정번호","입고전재고","재고","입고수"};
...
// 		GV_PART_CD_REV = request.getParameter("part_cd_rev");
    ...
    makeTableHTML.htmlTable_ID	= "TableS202S120120";
...
<script>
    $(document).ready(function () {
		...
		vTableS202S120120 = $('#<%=makeTableHTML.htmlTable_ID%>').DataTable({
			scrollX: true,
		    scrollY: 340,
		    scrollCollapse: true,
		    paging: false,
...
// 		    keys: false,
		...
		$('#<%=makeTableHTML.htmlTable_ID%> tbody').on( 'click', 'tr', function () {
			S202S120120_Row_index = vTableS202S120120
		        .row( this )
		        .index();
...
// 		    });
			...
			vTableS202S120120.row(this)
		    .nodes()
		    .to$()
		    .attr("class","hene-bg-color");
	
			$('#txt_store_no').val(vTableS202S120120.cell(S202S120120_Row_index, 0).data());	// machineno
			$('#txt_rakes_no').val(vTableS202S120120.cell(S202S120120_Row_index, 1).data());	// rakes
			$('#txt_plate_no').val(vTableS202S120120.cell(S202S120120_Row_index, 2).data());	// plate
			$('#txt_colm_no').val(vTableS202S120120.cell(S202S120120_Row_index, 3).data());		// colm
