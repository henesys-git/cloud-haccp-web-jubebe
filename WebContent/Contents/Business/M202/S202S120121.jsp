...
*/
	...
	String initIpgoTypeCode = "PART_IPGO_TYPE004";
...
<script type="text/javascript">
	...
	function SaveOderInfo() {
		...
		if($('#txt_io_count').val() == '') {
			...
			dataJsonBody.ipgo_type = $('#ipgo_type option:selected').val();		// 입고 타입	
			...
			if(chekrtn) {
				SendTojsp(JSONparam, "M202S120100E121");
			}
		}
	}
	    ...
	    $.ajax({
			...
			success: function (rcvData) {	
				if(rcvData > -1) {
					...
					heneSwal.error('입고 실패했습니다, 다시 시도해주세요');	         		
				}
	         }
	     });
	}
...
<table class="table">
	...
	<tr>
		...
		<td>
			<input type="text" class="form-control" id="txt_bigo" value="정상입고">
		</td>
	</tr>
</table>