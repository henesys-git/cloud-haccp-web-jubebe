...
//     TableModel = new DoyosaeTableModel("M202S010100E244", strColumnHead, param);	
    ...
    makeTableHTML.htmlTable_ID	= "TableS202S010245";
...
<script>
    $(document).ready(function () {
		...
		vTableS202S010245 = $('#<%=makeTableHTML.htmlTable_ID%>').DataTable({
			scrollX: true,
// 		    scrollY: 380,
...
// 			S202S010245_Row_index = vTableS202S010245
// 		        .row( this )
// 		        .index();


<%-- 	 		$(<%=makeTableHTML.htmlTable_ID%>_rowID).removeClass("hene-bg-color"); --%>
// 			vTableS202S010245.row(this)
// 		    .nodes()
// 		    .to$()
