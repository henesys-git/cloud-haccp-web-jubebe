<%--
===================================================================================
* 팝빌 계좌조회 API Java SDK JSP Example
*
* - JSP SDK 연동환경 설정방법 안내 : https://docs.popbill.com/easyfinbank/tutorial/java#jsp
* - 업데이트 일자 : 2020-07-14
...
<%@page errorPage="/popbill/exception.jsp" %>
<jsp:useBean id="easyFinBankService" scope="application" class="com.popbill.api.easyfin.EasyFinBankServiceImp"/>

<%-- 링크아이디 --%>
<jsp:setProperty name="easyFinBankService" property="linkID" value="JIKANGFOOD"/>

<%-- 비밀키, 사용자 인증에 사용되는 정보이므로 유출에 주의 --%>
<jsp:setProperty name="easyFinBankService" property="secretKey" value="IECNR1BWaqR7BuHz75PA6BuTHvRoHj1pj+hI504bO+k="/>
