...
<%-- 링크아이디 --%>
<jsp:setProperty name="kakaoService" property="linkID" value="CKBAENGI"/>

<%-- 비밀키, 사용자 인증에 사용되는 정보이므로 유출에 주의 --%>
<jsp:setProperty name="kakaoService" property="secretKey" value="fEJrxM1zK18ScUYMF6fmvqAKMuqLM+xy00NJoq4O5V8="/>
